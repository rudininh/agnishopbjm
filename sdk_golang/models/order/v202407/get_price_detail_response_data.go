...
import (
    ...
    "agnishopbjm/sdk_golang/utils"
            ...
            // checks if the Order202407GetPriceDetailResponseData type satisfies the MappedNullable interface at compile time
var _ utils.MappedNullable = &Order202407GetPriceDetailResponseData{}

// Order202407GetPriceDetailResponseData struct for Order202407GetPriceDetailResponseData
type Order202407GetPriceDetailResponseData struct {
    ...
    CodFeeNetAmount *string `json:"cod_fee_net_amount,omitempty"`
    ...
    LineItems []Order202407GetPriceDetailResponseDataLineItems `json:"line_items,omitempty"`
    // Price after tax 
...
type _Order202407GetPriceDetailResponseData Order202407GetPriceDetailResponseData

// NewOrder202407GetPriceDetailResponseData instantiates a new Order202407GetPriceDetailResponseData object
// This constructor will assign default values to properties that have it defined,
// and makes sure properties required by API are set, but the set of arguments
// will change when the set of required properties is changed
func NewOrder202407GetPriceDetailResponseData() *Order202407GetPriceDetailResponseData {
    this := Order202407GetPriceDetailResponseData{}
    return &this
}

// NewOrder202407GetPriceDetailResponseDataWithDefaults instantiates a new Order202407GetPriceDetailResponseData object
// This constructor will only assign default values to properties that have it defined,
// but it doesn't guarantee that properties required by API are set
func NewOrder202407GetPriceDetailResponseDataWithDefaults() *Order202407GetPriceDetailResponseData {
    this := Order202407GetPriceDetailResponseData{}
    return &this
}

// GetCodFee returns the CodFee field value if set, zero value otherwise.
func (o *Order202407GetPriceDetailResponseData) GetCodFee() string {
...
func (o *Order202407GetPriceDetailResponseData) GetCodFeeOk() (*string, bool) {
    if o == nil || utils.IsNil(o.CodFee) {
        return nil, false
    }
...
func (o *Order202407GetPriceDetailResponseData) HasCodFee() bool {
    if o != nil && !utils.IsNil(o.CodFee) {
        return true
    }
...
func (o *Order202407GetPriceDetailResponseData) SetCodFee(v string) {
    o.CodFee = &v
}

// GetCodFeeNetAmount returns the CodFeeNetAmount field value if set, zero value otherwise.
func (o *Order202407GetPriceDetailResponseData) GetCodFeeNetAmount() string {
    if o == nil || utils.IsNil(o.CodFeeNetAmount) {
        var ret string
        return ret
    }
    return *o.CodFeeNetAmount
}

// GetCodFeeNetAmountOk returns a tuple with the CodFeeNetAmount field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *Order202407GetPriceDetailResponseData) GetCodFeeNetAmountOk() (*string, bool) {
    if o == nil || utils.IsNil(o.CodFeeNetAmount) {
        return nil, false
    }
    return o.CodFeeNetAmount, true
}

// HasCodFeeNetAmount returns a boolean if a field has been set.
func (o *Order202407GetPriceDetailResponseData) HasCodFeeNetAmount() bool {
    if o != nil && !utils.IsNil(o.CodFeeNetAmount) {
        return true
    }
...
// SetCodFeeNetAmount gets a reference to the given string and assigns it to the CodFeeNetAmount field.
func (o *Order202407GetPriceDetailResponseData) SetCodFeeNetAmount(v string) {
    o.CodFeeNetAmount = &v
}

// GetCurrency returns the Currency field value if set, zero value otherwise.
func (o *Order202407GetPriceDetailResponseData) GetCurrency() string {
...
// and a boolean to check if the value has been set.
func (o *Order202407GetPriceDetailResponseData) GetCurrencyOk() (*string, bool) {
    if o == nil || utils.IsNil(o.Currency) {
        return nil, false
    }
...
func (o *Order202407GetPriceDetailResponseData) HasCurrency() bool {
    if o != nil && !utils.IsNil(o.Currency) {
        return true
    }
...
func (o *Order202407GetPriceDetailResponseData) SetCurrency(v string) {
    o.Currency = &v
}

// GetLineItems returns the LineItems field value if set, zero value otherwise.
func (o *Order202407GetPriceDetailResponseData) GetLineItems() []Order202407GetPriceDetailResponseDataLineItems {
    if o == nil || utils.IsNil(o.LineItems) {
        var ret []Order202407GetPriceDetailResponseDataLineItems
        return ret
    }
    return o.LineItems
}
...
// and a boolean to check if the value has been set.
func (o *Order202407GetPriceDetailResponseData) GetLineItemsOk() ([]Order202407GetPriceDetailResponseDataLineItems, bool) {
    if o == nil || utils.IsNil(o.LineItems) {
        return nil, false
    }
...
func (o *Order202407GetPriceDetailResponseData) HasLineItems() bool {
    if o != nil && !utils.IsNil(o.LineItems) {
        return true
    }
...
// SetLineItems gets a reference to the given []Order202407GetPriceDetailResponseDataLineItems and assigns it to the LineItems field.
func (o *Order202407GetPriceDetailResponseData) SetLineItems(v []Order202407GetPriceDetailResponseDataLineItems) {
    o.LineItems = v
}

// GetNetPriceAmount returns the NetPriceAmount field value if set, zero value otherwise.
func (o *Order202407GetPriceDetailResponseData) GetNetPriceAmount() string {
...
// and a boolean to check if the value has been set.
func (o *Order202407GetPriceDetailResponseData) GetNetPriceAmountOk() (*string, bool) {
    if o == nil || utils.IsNil(o.NetPriceAmount) {
        return nil, false
    }
...
func (o *Order202407GetPriceDetailResponseData) HasNetPriceAmount() bool {
    if o != nil && !utils.IsNil(o.NetPriceAmount) {
        return true
    }
...
func (o *Order202407GetPriceDetailResponseData) SetNetPriceAmount(v string) {
    o.NetPriceAmount = &v
}

// GetPayment returns the Payment field value if set, zero value otherwise.
func (o *Order202407GetPriceDetailResponseData) GetPayment() string {
...
// and a boolean to check if the value has been set.
func (o *Order202407GetPriceDetailResponseData) GetPaymentOk() (*string, bool) {
    if o == nil || utils.IsNil(o.Payment) {
        return nil, false
    }
...
func (o *Order202407GetPriceDetailResponseData) HasPayment() bool {
    if o != nil && !utils.IsNil(o.Payment) {
        return true
    }
...
func (o *Order202407GetPriceDetailResponseData) SetPayment(v string) {
    o.Payment = &v
}

// GetShippingFeeDeductionPlatform returns the ShippingFeeDeductionPlatform field value if set, zero value otherwise.
func (o *Order202407GetPriceDetailResponseData) GetShippingFeeDeductionPlatform() string {
...
// and a boolean to check if the value has been set.
func (o *Order202407GetPriceDetailResponseData) GetShippingFeeDeductionPlatformOk() (*string, bool) {
    if o == nil || utils.IsNil(o.ShippingFeeDeductionPlatform) {
        return nil, false
    }
...
func (o *Order202407GetPriceDetailResponseData) HasShippingFeeDeductionPlatform() bool {
    if o != nil && !utils.IsNil(o.ShippingFeeDeductionPlatform) {
        return true
    }
...
func (o *Order202407GetPriceDetailResponseData) SetShippingFeeDeductionPlatform(v string) {
...
func (o *Order202407GetPriceDetailResponseData) GetShippingFeeDeductionPlatformVoucher() string {
...
// and a boolean to check if the value has been set.
func (o *Order202407GetPriceDetailResponseData) GetShippingFeeDeductionPlatformVoucherOk() (*string, bool) {
    if o == nil || utils.IsNil(o.ShippingFeeDeductionPlatformVoucher) {
        return nil, false
    }
...
func (o *Order202407GetPriceDetailResponseData) HasShippingFeeDeductionPlatformVoucher() bool {
    if o != nil && !utils.IsNil(o.ShippingFeeDeductionPlatformVoucher) {
        return true
    }
...
func (o *Order202407GetPriceDetailResponseData) SetShippingFeeDeductionPlatformVoucher(v string) {
...
func (o *Order202407GetPriceDetailResponseData) GetShippingFeeDeductionSeller() string {
...
// and a boolean to check if the value has been set.
func (o *Order202407GetPriceDetailResponseData) GetShippingFeeDeductionSellerOk() (*string, bool) {
    if o == nil || utils.IsNil(o.ShippingFeeDeductionSeller) {
        return nil, false
    }
...
func (o *Order202407GetPriceDetailResponseData) HasShippingFeeDeductionSeller() bool {
    if o != nil && !utils.IsNil(o.ShippingFeeDeductionSeller) {
        return true
    }
...
func (o *Order202407GetPriceDetailResponseData) SetShippingFeeDeductionSeller(v string) {
    o.ShippingFeeDeductionSeller = &v
}

// GetShippingListPrice returns the ShippingListPrice field value if set, zero value otherwise.
func (o *Order202407GetPriceDetailResponseData) GetShippingListPrice() string {
...
// and a boolean to check if the value has been set.
func (o *Order202407GetPriceDetailResponseData) GetShippingListPriceOk() (*string, bool) {
    if o == nil || utils.IsNil(o.ShippingListPrice) {
        return nil, false
    }
...
func (o *Order202407GetPriceDetailResponseData) HasShippingListPrice() bool {
    if o != nil && !utils.IsNil(o.ShippingListPrice) {
        return true
    }
...
func (o *Order202407GetPriceDetailResponseData) SetShippingListPrice(v string) {
    o.ShippingListPrice = &v
}

// GetShippingSalePrice returns the ShippingSalePrice field value if set, zero value otherwise.
func (o *Order202407GetPriceDetailResponseData) GetShippingSalePrice() string {
...
// and a boolean to check if the value has been set.
func (o *Order202407GetPriceDetailResponseData) GetShippingSalePriceOk() (*string, bool) {
    if o == nil || utils.IsNil(o.ShippingSalePrice) {
        return nil, false
    }
...
func (o *Order202407GetPriceDetailResponseData) HasShippingSalePrice() bool {
    if o != nil && !utils.IsNil(o.ShippingSalePrice) {
        return true
    }
...
func (o *Order202407GetPriceDetailResponseData) SetShippingSalePrice(v string) {
    o.ShippingSalePrice = &v
}

// GetSkuGiftNetPrice returns the SkuGiftNetPrice field value if set, zero value otherwise.
func (o *Order202407GetPriceDetailResponseData) GetSkuGiftNetPrice() string {
...
// and a boolean to check if the value has been set.
func (o *Order202407GetPriceDetailResponseData) GetSkuGiftNetPriceOk() (*string, bool) {
    if o == nil || utils.IsNil(o.SkuGiftNetPrice) {
        return nil, false
    }
...
func (o *Order202407GetPriceDetailResponseData) HasSkuGiftNetPrice() bool {
    if o != nil && !utils.IsNil(o.SkuGiftNetPrice) {
        return true
    }
...
func (o *Order202407GetPriceDetailResponseData) SetSkuGiftNetPrice(v string) {
    o.SkuGiftNetPrice = &v
}

// GetSkuGiftOriginalPrice returns the SkuGiftOriginalPrice field value if set, zero value otherwise.
func (o *Order202407GetPriceDetailResponseData) GetSkuGiftOriginalPrice() string {
...
// and a boolean to check if the value has been set.
func (o *Order202407GetPriceDetailResponseData) GetSkuGiftOriginalPriceOk() (*string, bool) {
    if o == nil || utils.IsNil(o.SkuGiftOriginalPrice) {
        return nil, false
    }
...
func (o *Order202407GetPriceDetailResponseData) HasSkuGiftOriginalPrice() bool {
    if o != nil && !utils.IsNil(o.SkuGiftOriginalPrice) {
        return true
    }
...
func (o *Order202407GetPriceDetailResponseData) SetSkuGiftOriginalPrice(v string) {
    o.SkuGiftOriginalPrice = &v
}

// GetSkuListPrice returns the SkuListPrice field value if set, zero value otherwise.
func (o *Order202407GetPriceDetailResponseData) GetSkuListPrice() string {
...
// and a boolean to check if the value has been set.
func (o *Order202407GetPriceDetailResponseData) GetSkuListPriceOk() (*string, bool) {
    if o == nil || utils.IsNil(o.SkuListPrice) {
        return nil, false
    }
...
func (o *Order202407GetPriceDetailResponseData) HasSkuListPrice() bool {
    if o != nil && !utils.IsNil(o.SkuListPrice) {
        return true
    }
...
func (o *Order202407GetPriceDetailResponseData) SetSkuListPrice(v string) {
    o.SkuListPrice = &v
}

// GetSkuSalePrice returns the SkuSalePrice field value if set, zero value otherwise.
func (o *Order202407GetPriceDetailResponseData) GetSkuSalePrice() string {
...
// and a boolean to check if the value has been set.
func (o *Order202407GetPriceDetailResponseData) GetSkuSalePriceOk() (*string, bool) {
    if o == nil || utils.IsNil(o.SkuSalePrice) {
        return nil, false
    }
...
func (o *Order202407GetPriceDetailResponseData) HasSkuSalePrice() bool {
    if o != nil && !utils.IsNil(o.SkuSalePrice) {
        return true
    }
...
func (o *Order202407GetPriceDetailResponseData) SetSkuSalePrice(v string) {
    o.SkuSalePrice = &v
}

// GetSubtotal returns the Subtotal field value if set, zero value otherwise.
func (o *Order202407GetPriceDetailResponseData) GetSubtotal() string {
...
// and a boolean to check if the value has been set.
func (o *Order202407GetPriceDetailResponseData) GetSubtotalOk() (*string, bool) {
    if o == nil || utils.IsNil(o.Subtotal) {
        return nil, false
    }
...
func (o *Order202407GetPriceDetailResponseData) HasSubtotal() bool {
    if o != nil && !utils.IsNil(o.Subtotal) {
        return true
    }
...
func (o *Order202407GetPriceDetailResponseData) SetSubtotal(v string) {
    o.Subtotal = &v
}

// GetSubtotalDeductionPlatform returns the SubtotalDeductionPlatform field value if set, zero value otherwise.
func (o *Order202407GetPriceDetailResponseData) GetSubtotalDeductionPlatform() string {
...
// and a boolean to check if the value has been set.
func (o *Order202407GetPriceDetailResponseData) GetSubtotalDeductionPlatformOk() (*string, bool) {
    if o == nil || utils.IsNil(o.SubtotalDeductionPlatform) {
        return nil, false
    }
...
func (o *Order202407GetPriceDetailResponseData) HasSubtotalDeductionPlatform() bool {
    if o != nil && !utils.IsNil(o.SubtotalDeductionPlatform) {
        return true
    }
...
func (o *Order202407GetPriceDetailResponseData) SetSubtotalDeductionPlatform(v string) {
...
func (o *Order202407GetPriceDetailResponseData) GetSubtotalDeductionSeller() string {
...
// and a boolean to check if the value has been set.
func (o *Order202407GetPriceDetailResponseData) GetSubtotalDeductionSellerOk() (*string, bool) {
    if o == nil || utils.IsNil(o.SubtotalDeductionSeller) {
        return nil, false
    }
...
func (o *Order202407GetPriceDetailResponseData) HasSubtotalDeductionSeller() bool {
    if o != nil && !utils.IsNil(o.SubtotalDeductionSeller) {
        return true
    }
...
func (o *Order202407GetPriceDetailResponseData) SetSubtotalDeductionSeller(v string) {
    o.SubtotalDeductionSeller = &v
}

// GetSubtotalTaxAmount returns the SubtotalTaxAmount field value if set, zero value otherwise.
func (o *Order202407GetPriceDetailResponseData) GetSubtotalTaxAmount() string {
...
// and a boolean to check if the value has been set.
func (o *Order202407GetPriceDetailResponseData) GetSubtotalTaxAmountOk() (*string, bool) {
    if o == nil || utils.IsNil(o.SubtotalTaxAmount) {
        return nil, false
    }
...
func (o *Order202407GetPriceDetailResponseData) HasSubtotalTaxAmount() bool {
    if o != nil && !utils.IsNil(o.SubtotalTaxAmount) {
        return true
    }
...
func (o *Order202407GetPriceDetailResponseData) SetSubtotalTaxAmount(v string) {
    o.SubtotalTaxAmount = &v
}

// GetTaxAmount returns the TaxAmount field value if set, zero value otherwise.
func (o *Order202407GetPriceDetailResponseData) GetTaxAmount() string {
...
// and a boolean to check if the value has been set.
func (o *Order202407GetPriceDetailResponseData) GetTaxAmountOk() (*string, bool) {
    if o == nil || utils.IsNil(o.TaxAmount) {
        return nil, false
    }
...
func (o *Order202407GetPriceDetailResponseData) HasTaxAmount() bool {
    if o != nil && !utils.IsNil(o.TaxAmount) {
        return true
    }
...
func (o *Order202407GetPriceDetailResponseData) SetTaxAmount(v string) {
    o.TaxAmount = &v
}

// GetTaxRate returns the TaxRate field value if set, zero value otherwise.
func (o *Order202407GetPriceDetailResponseData) GetTaxRate() string {
...
// and a boolean to check if the value has been set.
func (o *Order202407GetPriceDetailResponseData) GetTaxRateOk() (*string, bool) {
    if o == nil || utils.IsNil(o.TaxRate) {
        return nil, false
    }
...
func (o *Order202407GetPriceDetailResponseData) HasTaxRate() bool {
    if o != nil && !utils.IsNil(o.TaxRate) {
        return true
    }
...
func (o *Order202407GetPriceDetailResponseData) SetTaxRate(v string) {
    o.TaxRate = &v
}

// GetTotal returns the Total field value if set, zero value otherwise.
func (o *Order202407GetPriceDetailResponseData) GetTotal() string {
...
// and a boolean to check if the value has been set.
func (o *Order202407GetPriceDetailResponseData) GetTotalOk() (*string, bool) {
    if o == nil || utils.IsNil(o.Total) {
        return nil, false
    }
    return o.Total, true
...
func (o *Order202407GetPriceDetailResponseData) HasTotal() bool {
    if o != nil && !utils.IsNil(o.Total) {
        return true
    }
...
func (o *Order202407GetPriceDetailResponseData) SetTotal(v string) {
    o.Total = &v
}

// GetVoucherDeductionPlatform returns the VoucherDeductionPlatform field value if set, zero value otherwise.
func (o *Order202407GetPriceDetailResponseData) GetVoucherDeductionPlatform() string {
...
// and a boolean to check if the value has been set.
func (o *Order202407GetPriceDetailResponseData) GetVoucherDeductionPlatformOk() (*string, bool) {
    if o == nil || utils.IsNil(o.VoucherDeductionPlatform) {
        return nil, false
    }
...
func (o *Order202407GetPriceDetailResponseData) HasVoucherDeductionPlatform() bool {
    if o != nil && !utils.IsNil(o.VoucherDeductionPlatform) {
        return true
    }
...
func (o *Order202407GetPriceDetailResponseData) SetVoucherDeductionPlatform(v string) {
...
func (o *Order202407GetPriceDetailResponseData) GetVoucherDeductionSeller() string {
...
// and a boolean to check if the value has been set.
func (o *Order202407GetPriceDetailResponseData) GetVoucherDeductionSellerOk() (*string, bool) {
    if o == nil || utils.IsNil(o.VoucherDeductionSeller) {
        return nil, false
    }
...
func (o *Order202407GetPriceDetailResponseData) HasVoucherDeductionSeller() bool {
    if o != nil && !utils.IsNil(o.VoucherDeductionSeller) {
        return true
    }
...
func (o *Order202407GetPriceDetailResponseData) SetVoucherDeductionSeller(v string) {
    o.VoucherDeductionSeller = &v
}

func (o Order202407GetPriceDetailResponseData) MarshalJSON() ([]byte, error) {
...
func (o Order202407GetPriceDetailResponseData) ToMap() (map[string]interface{}, error) {
    toSerialize := map[string]interface{}{}
    if !utils.IsNil(o.CodFee) {
        toSerialize["cod_fee"] = o.CodFee
    }
    if !utils.IsNil(o.CodFeeNetAmount) {
        toSerialize["cod_fee_net_amount"] = o.CodFeeNetAmount
    }
...
func (o *Order202407GetPriceDetailResponseData) UnmarshalJSON(data []byte) (err error) {
    varOrder202407GetPriceDetailResponseData := _Order202407GetPriceDetailResponseData{}

    err = json.Unmarshal(data, &varOrder202407GetPriceDetailResponseData)

    if err != nil {
        return err
    }

    *o = Order202407GetPriceDetailResponseData(varOrder202407GetPriceDetailResponseData)

    additionalProperties := make(map[string]interface{})

    if err = json.Unmarshal(data, &additionalProperties); err == nil {
        delete(additionalProperties, "cod_fee")
        delete(additionalProperties, "cod_fee_net_amount")
...
type NullableOrder202407GetPriceDetailResponseData struct {
	value *Order202407GetPriceDetailResponseData
	isSet bool
}

func (v NullableOrder202407GetPriceDetailResponseData) Get() *Order202407GetPriceDetailResponseData {
	return v.value
}

func (v *NullableOrder202407GetPriceDetailResponseData) Set(val *Order202407GetPriceDetailResponseData) {
	v.value = val
	v.isSet = true
}

func (v NullableOrder202407GetPriceDetailResponseData) IsSet() bool {
	return v.isSet
}

func (v *NullableOrder202407GetPriceDetailResponseData) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableOrder202407GetPriceDetailResponseData(val *Order202407GetPriceDetailResponseData) *NullableOrder202407GetPriceDetailResponseData {
	return &NullableOrder202407GetPriceDetailResponseData{value: val, isSet: true}
}

func (v NullableOrder202407GetPriceDetailResponseData) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableOrder202407GetPriceDetailResponseData) UnmarshalJSON(src []byte) error {
	v.isSet = true
