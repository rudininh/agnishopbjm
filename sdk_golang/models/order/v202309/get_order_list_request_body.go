...
type _Order202309GetOrderListRequestBody Order202309GetOrderListRequestBody
...
func (o *Order202309GetOrderListRequestBody) UnmarshalJSON(data []byte) (err error) {
    varOrder202309GetOrderListRequestBody := _Order202309GetOrderListRequestBody{}

    err = json.Unmarshal(data, &varOrder202309GetOrderListRequestBody)

    if err != nil {
        return err
    }

    *o = Order202309GetOrderListRequestBody(varOrder202309GetOrderListRequestBody)
    ...
    if err = json.Unmarshal(data, &additionalProperties); err == nil {
        ...
        delete(additionalProperties, "order_status")
        ...
        delete(additionalProperties, "warehouse_ids")
