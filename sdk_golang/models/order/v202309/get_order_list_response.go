...
type _Order202309GetOrderListResponse Order202309GetOrderListResponse
...
func (o *Order202309GetOrderListResponse) UnmarshalJSON(data []byte) (err error) {
    varOrder202309GetOrderListResponse := _Order202309GetOrderListResponse{}

    err = json.Unmarshal(data, &varOrder202309GetOrderListResponse)

    if err != nil {
        return err
    }

    *o = Order202309GetOrderListResponse(varOrder202309GetOrderListResponse)
