...
type _Order202309GetOrderListResponseDataOrdersRecipientAddress Order202309GetOrderListResponseDataOrdersRecipientAddress
...
func (o *Order202309GetOrderListResponseDataOrdersRecipientAddress) UnmarshalJSON(data []byte) (err error) {
    varOrder202309GetOrderListResponseDataOrdersRecipientAddress := _Order202309GetOrderListResponseDataOrdersRecipientAddress{}

    err = json.Unmarshal(data, &varOrder202309GetOrderListResponseDataOrdersRecipientAddress)

    if err != nil {
        return err
    }

    *o = Order202309GetOrderListResponseDataOrdersRecipientAddress(varOrder202309GetOrderListResponseDataOrdersRecipientAddress)
