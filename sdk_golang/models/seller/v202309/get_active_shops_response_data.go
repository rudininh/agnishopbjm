...
type _Seller202309GetActiveShopsResponseData Seller202309GetActiveShopsResponseData
...
func (o *Seller202309GetActiveShopsResponseData) UnmarshalJSON(data []byte) (err error) {
    varSeller202309GetActiveShopsResponseData := _Seller202309GetActiveShopsResponseData{}

    err = json.Unmarshal(data, &varSeller202309GetActiveShopsResponseData)

    if err != nil {
        return err
    }

    *o = Seller202309GetActiveShopsResponseData(varSeller202309GetActiveShopsResponseData)
