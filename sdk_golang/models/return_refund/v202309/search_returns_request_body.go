...
type _ReturnRefund202309SearchReturnsRequestBody ReturnRefund202309SearchReturnsRequestBody
...
func (o *ReturnRefund202309SearchReturnsRequestBody) UnmarshalJSON(data []byte) (err error) {
    varReturnRefund202309SearchReturnsRequestBody := _ReturnRefund202309SearchReturnsRequestBody{}

    err = json.Unmarshal(data, &varReturnRefund202309SearchReturnsRequestBody)

    if err != nil {
        return err
    }

    *o = ReturnRefund202309SearchReturnsRequestBody(varReturnRefund202309SearchReturnsRequestBody)
    ...
    if err = json.Unmarshal(data, &additionalProperties); err == nil {
        ...
        delete(additionalProperties, "return_ids")
        delete(additionalProperties, "return_status")
        delete(additionalProperties, "return_types")
