...
type _ReturnRefund202309CalculateRefundResponseDataOrderRefundAmount ReturnRefund202309CalculateRefundResponseDataOrderRefundAmount
...
func (o *ReturnRefund202309CalculateRefundResponseDataOrderRefundAmount) UnmarshalJSON(data []byte) (err error) {
    varReturnRefund202309CalculateRefundResponseDataOrderRefundAmount := _ReturnRefund202309CalculateRefundResponseDataOrderRefundAmount{}

    err = json.Unmarshal(data, &varReturnRefund202309CalculateRefundResponseDataOrderRefundAmount)

    if err != nil {
        return err
    }

    *o = ReturnRefund202309CalculateRefundResponseDataOrderRefundAmount(varReturnRefund202309CalculateRefundResponseDataOrderRefundAmount)
