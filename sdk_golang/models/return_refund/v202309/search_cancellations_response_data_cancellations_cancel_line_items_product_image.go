...
type _ReturnRefund202309SearchCancellationsResponseDataCancellationsCancelLineItemsProductImage ReturnRefund202309SearchCancellationsResponseDataCancellationsCancelLineItemsProductImage
...
func (o *ReturnRefund202309SearchCancellationsResponseDataCancellationsCancelLineItemsProductImage) UnmarshalJSON(data []byte) (err error) {
    varReturnRefund202309SearchCancellationsResponseDataCancellationsCancelLineItemsProductImage := _ReturnRefund202309SearchCancellationsResponseDataCancellationsCancelLineItemsProductImage{}

    err = json.Unmarshal(data, &varReturnRefund202309SearchCancellationsResponseDataCancellationsCancelLineItemsProductImage)

    if err != nil {
        return err
    }

    *o = ReturnRefund202309SearchCancellationsResponseDataCancellationsCancelLineItemsProductImage(varReturnRefund202309SearchCancellationsResponseDataCancellationsCancelLineItemsProductImage)
