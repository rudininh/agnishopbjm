...
type _ReturnRefund202309GetAftersaleEligibilityResponseDataSkuEligibilityLineItemEligibility ReturnRefund202309GetAftersaleEligibilityResponseDataSkuEligibilityLineItemEligibility
...
func (o *ReturnRefund202309GetAftersaleEligibilityResponseDataSkuEligibilityLineItemEligibility) UnmarshalJSON(data []byte) (err error) {
    varReturnRefund202309GetAftersaleEligibilityResponseDataSkuEligibilityLineItemEligibility := _ReturnRefund202309GetAftersaleEligibilityResponseDataSkuEligibilityLineItemEligibility{}

    err = json.Unmarshal(data, &varReturnRefund202309GetAftersaleEligibilityResponseDataSkuEligibilityLineItemEligibility)

    if err != nil {
        return err
    }

    *o = ReturnRefund202309GetAftersaleEligibilityResponseDataSkuEligibilityLineItemEligibility(varReturnRefund202309GetAftersaleEligibilityResponseDataSkuEligibilityLineItemEligibility)

    additionalProperties := make(map[string]interface{})

    if err = json.Unmarshal(data, &additionalProperties); err == nil {
        delete(additionalProperties, "eligible")
        delete(additionalProperties, "ineligible_code")
        delete(additionalProperties, "ineligible_reason")
        delete(additionalProperties, "order_line_items_ids")
