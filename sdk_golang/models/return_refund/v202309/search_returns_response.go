...
type _ReturnRefund202309SearchReturnsResponse ReturnRefund202309SearchReturnsResponse
...
func (o *ReturnRefund202309SearchReturnsResponse) UnmarshalJSON(data []byte) (err error) {
    varReturnRefund202309SearchReturnsResponse := _ReturnRefund202309SearchReturnsResponse{}

    err = json.Unmarshal(data, &varReturnRefund202309SearchReturnsResponse)

    if err != nil {
        return err
    }

    *o = ReturnRefund202309SearchReturnsResponse(varReturnRefund202309SearchReturnsResponse)
