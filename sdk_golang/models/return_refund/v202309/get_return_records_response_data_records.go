...
type _ReturnRefund202309GetReturnRecordsResponseDataRecords ReturnRefund202309GetReturnRecordsResponseDataRecords
...
func (o *ReturnRefund202309GetReturnRecordsResponseDataRecords) UnmarshalJSON(data []byte) (err error) {
    varReturnRefund202309GetReturnRecordsResponseDataRecords := _ReturnRefund202309GetReturnRecordsResponseDataRecords{}

    err = json.Unmarshal(data, &varReturnRefund202309GetReturnRecordsResponseDataRecords)

    if err != nil {
        return err
    }

    *o = ReturnRefund202309GetReturnRecordsResponseDataRecords(varReturnRefund202309GetReturnRecordsResponseDataRecords)
    ...
    if err = json.Unmarshal(data, &additionalProperties); err == nil {
        ...
        delete(additionalProperties, "reason_text")
