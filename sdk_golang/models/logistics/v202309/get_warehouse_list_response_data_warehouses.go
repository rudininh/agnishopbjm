...
type _Logistics202309GetWarehouseListResponseDataWarehouses Logistics202309GetWarehouseListResponseDataWarehouses
...
func (o *Logistics202309GetWarehouseListResponseDataWarehouses) GetEntityId() string {
    if o == nil || utils.IsNil(o.EntityId) {
        var ret string
        return ret
    }
    return *o.EntityId
...
// and a boolean to check if the value has been set.
func (o *Logistics202309GetWarehouseListResponseDataWarehouses) GetEntityIdOk() (*string, bool) {
    if o == nil || utils.IsNil(o.EntityId) {
        return nil, false
    }
...
func (o *Logistics202309GetWarehouseListResponseDataWarehouses) HasEntityId() bool {
    if o != nil && !utils.IsNil(o.EntityId) {
        return true
    }
...
func (o *Logistics202309GetWarehouseListResponseDataWarehouses) SetEntityId(v string) {
    o.EntityId = &v
}
...
func (o *Logistics202309GetWarehouseListResponseDataWarehouses) UnmarshalJSON(data []byte) (err error) {
    varLogistics202309GetWarehouseListResponseDataWarehouses := _Logistics202309GetWarehouseListResponseDataWarehouses{}

    err = json.Unmarshal(data, &varLogistics202309GetWarehouseListResponseDataWarehouses)

    if err != nil {
        return err
    }

    *o = Logistics202309GetWarehouseListResponseDataWarehouses(varLogistics202309GetWarehouseListResponseDataWarehouses)

    additionalProperties := make(map[string]interface{})

    if err = json.Unmarshal(data, &additionalProperties); err == nil {
        delete(additionalProperties, "address")
        delete(additionalProperties, "effect_status")
