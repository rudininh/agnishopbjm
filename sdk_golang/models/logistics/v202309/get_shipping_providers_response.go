...
type _Logistics202309GetShippingProvidersResponse Logistics202309GetShippingProvidersResponse
...
func (o *Logistics202309GetShippingProvidersResponse) UnmarshalJSON(data []byte) (err error) {
    varLogistics202309GetShippingProvidersResponse := _Logistics202309GetShippingProvidersResponse{}

    err = json.Unmarshal(data, &varLogistics202309GetShippingProvidersResponse)

    if err != nil {
        return err
    }

    *o = Logistics202309GetShippingProvidersResponse(varLogistics202309GetShippingProvidersResponse)
