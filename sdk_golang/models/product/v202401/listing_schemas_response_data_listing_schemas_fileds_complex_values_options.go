...
type _Product202401ListingSchemasResponseDataListingSchemasFiledsComplexValuesOptions Product202401ListingSchemasResponseDataListingSchemasFiledsComplexValuesOptions
...
func (o *Product202401ListingSchemasResponseDataListingSchemasFiledsComplexValuesOptions) UnmarshalJSON(data []byte) (err error) {
    varProduct202401ListingSchemasResponseDataListingSchemasFiledsComplexValuesOptions := _Product202401ListingSchemasResponseDataListingSchemasFiledsComplexValuesOptions{}

    err = json.Unmarshal(data, &varProduct202401ListingSchemasResponseDataListingSchemasFiledsComplexValuesOptions)

    if err != nil {
        return err
    }

    *o = Product202401ListingSchemasResponseDataListingSchemasFiledsComplexValuesOptions(varProduct202401ListingSchemasResponseDataListingSchemasFiledsComplexValuesOptions)
