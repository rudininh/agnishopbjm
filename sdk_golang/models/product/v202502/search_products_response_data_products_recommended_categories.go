...
type _Product202502SearchProductsResponseDataProductsRecommendedCategories Product202502SearchProductsResponseDataProductsRecommendedCategories
...
func (o *Product202502SearchProductsResponseDataProductsRecommendedCategories) UnmarshalJSON(data []byte) (err error) {
    varProduct202502SearchProductsResponseDataProductsRecommendedCategories := _Product202502SearchProductsResponseDataProductsRecommendedCategories{}

    err = json.Unmarshal(data, &varProduct202502SearchProductsResponseDataProductsRecommendedCategories)

    if err != nil {
        return err
    }

    *o = Product202502SearchProductsResponseDataProductsRecommendedCategories(varProduct202502SearchProductsResponseDataProductsRecommendedCategories)
