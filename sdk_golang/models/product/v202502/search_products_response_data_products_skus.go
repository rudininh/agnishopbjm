...
type Product202502SearchProductsResponseDataProductsSkus struct {
    ...
    Fees []Product202502SearchProductsResponseDataProductsSkusFees `json:"fees,omitempty"`
    ...
    StatusInfo *Product202502SearchProductsResponseDataProductsSkusStatusInfo `json:"status_info,omitempty"`
    AdditionalProperties map[string]interface{}
}

type _Product202502SearchProductsResponseDataProductsSkus Product202502SearchProductsResponseDataProductsSkus
...
func (o *Product202502SearchProductsResponseDataProductsSkus) GetFees() []Product202502SearchProductsResponseDataProductsSkusFees {
    if o == nil || utils.IsNil(o.Fees) {
        var ret []Product202502SearchProductsResponseDataProductsSkusFees
        return ret
    }
    return o.Fees
}
...
// and a boolean to check if the value has been set.
func (o *Product202502SearchProductsResponseDataProductsSkus) GetFeesOk() ([]Product202502SearchProductsResponseDataProductsSkusFees, bool) {
    if o == nil || utils.IsNil(o.Fees) {
        return nil, false
    }
    return o.Fees, true
...
func (o *Product202502SearchProductsResponseDataProductsSkus) HasFees() bool {
    if o != nil && !utils.IsNil(o.Fees) {
        return true
    }
...
// SetFees gets a reference to the given []Product202502SearchProductsResponseDataProductsSkusFees and assigns it to the Fees field.
func (o *Product202502SearchProductsResponseDataProductsSkus) SetFees(v []Product202502SearchProductsResponseDataProductsSkusFees) {
    o.Fees = v
}
...
func (o *Product202502SearchProductsResponseDataProductsSkus) GetStatusInfo() Product202502SearchProductsResponseDataProductsSkusStatusInfo {
    if o == nil || utils.IsNil(o.StatusInfo) {
        var ret Product202502SearchProductsResponseDataProductsSkusStatusInfo
        return ret
    }
    return *o.StatusInfo
}
...
// and a boolean to check if the value has been set.
func (o *Product202502SearchProductsResponseDataProductsSkus) GetStatusInfoOk() (*Product202502SearchProductsResponseDataProductsSkusStatusInfo, bool) {
    if o == nil || utils.IsNil(o.StatusInfo) {
        return nil, false
    }
...
func (o *Product202502SearchProductsResponseDataProductsSkus) HasStatusInfo() bool {
    if o != nil && !utils.IsNil(o.StatusInfo) {
        return true
    }
...
// SetStatusInfo gets a reference to the given Product202502SearchProductsResponseDataProductsSkusStatusInfo and assigns it to the StatusInfo field.
func (o *Product202502SearchProductsResponseDataProductsSkus) SetStatusInfo(v Product202502SearchProductsResponseDataProductsSkusStatusInfo) {
    o.StatusInfo = &v
}
...
func (o *Product202502SearchProductsResponseDataProductsSkus) UnmarshalJSON(data []byte) (err error) {
    varProduct202502SearchProductsResponseDataProductsSkus := _Product202502SearchProductsResponseDataProductsSkus{}

    err = json.Unmarshal(data, &varProduct202502SearchProductsResponseDataProductsSkus)

    if err != nil {
        return err
    }

    *o = Product202502SearchProductsResponseDataProductsSkus(varProduct202502SearchProductsResponseDataProductsSkus)
    ...
    if err = json.Unmarshal(data, &additionalProperties); err == nil {
        ...
        delete(additionalProperties, "status_info")
