...
type Product202502SearchProductsRequestBody struct {
    ...
    SnsFilter *string `json:"sns_filter,omitempty"`
...
type _Product202502SearchProductsRequestBody Product202502SearchProductsRequestBody
...
// GetSnsFilter returns the SnsFilter field value if set, zero value otherwise.
func (o *Product202502SearchProductsRequestBody) GetSnsFilter() string {
    if o == nil || utils.IsNil(o.SnsFilter) {
        var ret string
        return ret
    }
    return *o.SnsFilter
...
// GetSnsFilterOk returns a tuple with the SnsFilter field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *Product202502SearchProductsRequestBody) GetSnsFilterOk() (*string, bool) {
    if o == nil || utils.IsNil(o.SnsFilter) {
        return nil, false
    }
    return o.SnsFilter, true
}

// HasSnsFilter returns a boolean if a field has been set.
func (o *Product202502SearchProductsRequestBody) HasSnsFilter() bool {
    if o != nil && !utils.IsNil(o.SnsFilter) {
        return true
    }
...
// SetSnsFilter gets a reference to the given string and assigns it to the SnsFilter field.
func (o *Product202502SearchProductsRequestBody) SetSnsFilter(v string) {
    o.SnsFilter = &v
}
...
func (o Product202502SearchProductsRequestBody) ToMap() (map[string]interface{}, error) {
    ...
    if !utils.IsNil(o.SnsFilter) {
        toSerialize["sns_filter"] = o.SnsFilter
    }
...
func (o *Product202502SearchProductsRequestBody) UnmarshalJSON(data []byte) (err error) {
    varProduct202502SearchProductsRequestBody := _Product202502SearchProductsRequestBody{}

    err = json.Unmarshal(data, &varProduct202502SearchProductsRequestBody)

    if err != nil {
        return err
    }

    *o = Product202502SearchProductsRequestBody(varProduct202502SearchProductsRequestBody)

    additionalProperties := make(map[string]interface{})

    if err = json.Unmarshal(data, &additionalProperties); err == nil {
        delete(additionalProperties, "audit_status")
        ...
        delete(additionalProperties, "listing_quality_tiers")
        delete(additionalProperties, "return_draft_version")
        delete(additionalProperties, "seller_skus")
        delete(additionalProperties, "sku_ids")
        delete(additionalProperties, "sns_filter")
