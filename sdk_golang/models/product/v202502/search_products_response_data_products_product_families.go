...
type _Product202502SearchProductsResponseDataProductsProductFamilies Product202502SearchProductsResponseDataProductsProductFamilies
...
func (o *Product202502SearchProductsResponseDataProductsProductFamilies) UnmarshalJSON(data []byte) (err error) {
    varProduct202502SearchProductsResponseDataProductsProductFamilies := _Product202502SearchProductsResponseDataProductsProductFamilies{}

    err = json.Unmarshal(data, &varProduct202502SearchProductsResponseDataProductsProductFamilies)

    if err != nil {
        return err
    }

    *o = Product202502SearchProductsResponseDataProductsProductFamilies(varProduct202502SearchProductsResponseDataProductsProductFamilies)
