...
type _Product202407ListingSchemasResponseDataListingSchemasFields Product202407ListingSchemasResponseDataListingSchemasFields
...
func (o *Product202407ListingSchemasResponseDataListingSchemasFields) UnmarshalJSON(data []byte) (err error) {
    varProduct202407ListingSchemasResponseDataListingSchemasFields := _Product202407ListingSchemasResponseDataListingSchemasFields{}

    err = json.Unmarshal(data, &varProduct202407ListingSchemasResponseDataListingSchemasFields)

    if err != nil {
        return err
    }

    *o = Product202407ListingSchemasResponseDataListingSchemasFields(varProduct202407ListingSchemasResponseDataListingSchemasFields)
