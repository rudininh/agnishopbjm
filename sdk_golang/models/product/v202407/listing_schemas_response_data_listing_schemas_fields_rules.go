...
type _Product202407ListingSchemasResponseDataListingSchemasFieldsRules Product202407ListingSchemasResponseDataListingSchemasFieldsRules
...
func (o *Product202407ListingSchemasResponseDataListingSchemasFieldsRules) UnmarshalJSON(data []byte) (err error) {
    varProduct202407ListingSchemasResponseDataListingSchemasFieldsRules := _Product202407ListingSchemasResponseDataListingSchemasFieldsRules{}

    err = json.Unmarshal(data, &varProduct202407ListingSchemasResponseDataListingSchemasFieldsRules)

    if err != nil {
        return err
    }

    *o = Product202407ListingSchemasResponseDataListingSchemasFieldsRules(varProduct202407ListingSchemasResponseDataListingSchemasFieldsRules)
