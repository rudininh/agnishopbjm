...
type _Product202407SearchSizeChartsResponse Product202407SearchSizeChartsResponse
...
func (o *Product202407SearchSizeChartsResponse) UnmarshalJSON(data []byte) (err error) {
    varProduct202407SearchSizeChartsResponse := _Product202407SearchSizeChartsResponse{}

    err = json.Unmarshal(data, &varProduct202407SearchSizeChartsResponse)

    if err != nil {
        return err
    }

    *o = Product202407SearchSizeChartsResponse(varProduct202407SearchSizeChartsResponse)
