...
type _Product202407ListingSchemasResponseDataListingSchemasFieldsComplexValuesOptions Product202407ListingSchemasResponseDataListingSchemasFieldsComplexValuesOptions
...
func (o *Product202407ListingSchemasResponseDataListingSchemasFieldsComplexValuesOptions) UnmarshalJSON(data []byte) (err error) {
    varProduct202407ListingSchemasResponseDataListingSchemasFieldsComplexValuesOptions := _Product202407ListingSchemasResponseDataListingSchemasFieldsComplexValuesOptions{}

    err = json.Unmarshal(data, &varProduct202407ListingSchemasResponseDataListingSchemasFieldsComplexValuesOptions)

    if err != nil {
        return err
    }

    *o = Product202407ListingSchemasResponseDataListingSchemasFieldsComplexValuesOptions(varProduct202407ListingSchemasResponseDataListingSchemasFieldsComplexValuesOptions)
