...
type _Product202312SearchProductsRequestBody Product202312SearchProductsRequestBody
...
func (o *Product202312SearchProductsRequestBody) UnmarshalJSON(data []byte) (err error) {
    varProduct202312SearchProductsRequestBody := _Product202312SearchProductsRequestBody{}

    err = json.Unmarshal(data, &varProduct202312SearchProductsRequestBody)

    if err != nil {
        return err
    }

    *o = Product202312SearchProductsRequestBody(varProduct202312SearchProductsRequestBody)
