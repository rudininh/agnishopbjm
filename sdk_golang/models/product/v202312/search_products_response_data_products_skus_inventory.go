...
type _Product202312SearchProductsResponseDataProductsSkusInventory Product202312SearchProductsResponseDataProductsSkusInventory
...
func (o *Product202312SearchProductsResponseDataProductsSkusInventory) UnmarshalJSON(data []byte) (err error) {
    varProduct202312SearchProductsResponseDataProductsSkusInventory := _Product202312SearchProductsResponseDataProductsSkusInventory{}

    err = json.Unmarshal(data, &varProduct202312SearchProductsResponseDataProductsSkusInventory)

    if err != nil {
        return err
    }

    *o = Product202312SearchProductsResponseDataProductsSkusInventory(varProduct202312SearchProductsResponseDataProductsSkusInventory)
