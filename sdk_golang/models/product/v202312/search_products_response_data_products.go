...
type _Product202312SearchProductsResponseDataProducts Product202312SearchProductsResponseDataProducts
...
func (o *Product202312SearchProductsResponseDataProducts) UnmarshalJSON(data []byte) (err error) {
    varProduct202312SearchProductsResponseDataProducts := _Product202312SearchProductsResponseDataProducts{}

    err = json.Unmarshal(data, &varProduct202312SearchProductsResponseDataProducts)

    if err != nil {
        return err
    }

    *o = Product202312SearchProductsResponseDataProducts(varProduct202312SearchProductsResponseDataProducts)
