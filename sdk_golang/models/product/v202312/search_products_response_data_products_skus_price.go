...
type _Product202312SearchProductsResponseDataProductsSkusPrice Product202312SearchProductsResponseDataProductsSkusPrice
...
func (o *Product202312SearchProductsResponseDataProductsSkusPrice) UnmarshalJSON(data []byte) (err error) {
    varProduct202312SearchProductsResponseDataProductsSkusPrice := _Product202312SearchProductsResponseDataProductsSkusPrice{}

    err = json.Unmarshal(data, &varProduct202312SearchProductsResponseDataProductsSkusPrice)

    if err != nil {
        return err
    }

    *o = Product202312SearchProductsResponseDataProductsSkusPrice(varProduct202312SearchProductsResponseDataProductsSkusPrice)
