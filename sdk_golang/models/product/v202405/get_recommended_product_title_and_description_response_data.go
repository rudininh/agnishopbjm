...
type _Product202405GetRecommendedProductTitleAndDescriptionResponseData Product202405GetRecommendedProductTitleAndDescriptionResponseData
...
func (o *Product202405GetRecommendedProductTitleAndDescriptionResponseData) UnmarshalJSON(data []byte) (err error) {
    varProduct202405GetRecommendedProductTitleAndDescriptionResponseData := _Product202405GetRecommendedProductTitleAndDescriptionResponseData{}

    err = json.Unmarshal(data, &varProduct202405GetRecommendedProductTitleAndDescriptionResponseData)

    if err != nil {
        return err
    }

    *o = Product202405GetRecommendedProductTitleAndDescriptionResponseData(varProduct202405GetRecommendedProductTitleAndDescriptionResponseData)
