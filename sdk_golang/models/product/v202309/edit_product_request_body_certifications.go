...
type _Product202309EditProductRequestBodyCertifications Product202309EditProductRequestBodyCertifications
...
func (o *Product202309EditProductRequestBodyCertifications) UnmarshalJSON(data []byte) (err error) {
    varProduct202309EditProductRequestBodyCertifications := _Product202309EditProductRequestBodyCertifications{}

    err = json.Unmarshal(data, &varProduct202309EditProductRequestBodyCertifications)

    if err != nil {
        return err
    }

    *o = Product202309EditProductRequestBodyCertifications(varProduct202309EditProductRequestBodyCertifications)
