...
type _Product202309RecommendCategoryResponseDataCategories Product202309RecommendCategoryResponseDataCategories
...
func (o *Product202309RecommendCategoryResponseDataCategories) UnmarshalJSON(data []byte) (err error) {
    varProduct202309RecommendCategoryResponseDataCategories := _Product202309RecommendCategoryResponseDataCategories{}

    err = json.Unmarshal(data, &varProduct202309RecommendCategoryResponseDataCategories)

    if err != nil {
        return err
    }

    *o = Product202309RecommendCategoryResponseDataCategories(varProduct202309RecommendCategoryResponseDataCategories)
