...
type _Product202309GetProductResponseDataSkusSalesAttributesSkuImg Product202309GetProductResponseDataSkusSalesAttributesSkuImg
...
func (o *Product202309GetProductResponseDataSkusSalesAttributesSkuImg) UnmarshalJSON(data []byte) (err error) {
    varProduct202309GetProductResponseDataSkusSalesAttributesSkuImg := _Product202309GetProductResponseDataSkusSalesAttributesSkuImg{}

    err = json.Unmarshal(data, &varProduct202309GetProductResponseDataSkusSalesAttributesSkuImg)

    if err != nil {
        return err
    }

    *o = Product202309GetProductResponseDataSkusSalesAttributesSkuImg(varProduct202309GetProductResponseDataSkusSalesAttributesSkuImg)
