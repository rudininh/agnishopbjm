...
type _Product202309GetGlobalAttributesResponseDataAttributesRequirementConditions Product202309GetGlobalAttributesResponseDataAttributesRequirementConditions
...
func (o *Product202309GetGlobalAttributesResponseDataAttributesRequirementConditions) UnmarshalJSON(data []byte) (err error) {
    varProduct202309GetGlobalAttributesResponseDataAttributesRequirementConditions := _Product202309GetGlobalAttributesResponseDataAttributesRequirementConditions{}

    err = json.Unmarshal(data, &varProduct202309GetGlobalAttributesResponseDataAttributesRequirementConditions)

    if err != nil {
        return err
    }

    *o = Product202309GetGlobalAttributesResponseDataAttributesRequirementConditions(varProduct202309GetGlobalAttributesResponseDataAttributesRequirementConditions)
