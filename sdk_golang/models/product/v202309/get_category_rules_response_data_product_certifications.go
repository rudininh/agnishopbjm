...
type _Product202309GetCategoryRulesResponseDataProductCertifications Product202309GetCategoryRulesResponseDataProductCertifications
...
func (o *Product202309GetCategoryRulesResponseDataProductCertifications) UnmarshalJSON(data []byte) (err error) {
    varProduct202309GetCategoryRulesResponseDataProductCertifications := _Product202309GetCategoryRulesResponseDataProductCertifications{}

    err = json.Unmarshal(data, &varProduct202309GetCategoryRulesResponseDataProductCertifications)

    if err != nil {
        return err
    }

    *o = Product202309GetCategoryRulesResponseDataProductCertifications(varProduct202309GetCategoryRulesResponseDataProductCertifications)

    additionalProperties := make(map[string]interface{})

    if err = json.Unmarshal(data, &additionalProperties); err == nil {
        delete(additionalProperties, "document_details")
