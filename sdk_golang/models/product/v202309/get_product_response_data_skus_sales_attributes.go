...
type _Product202309GetProductResponseDataSkusSalesAttributes Product202309GetProductResponseDataSkusSalesAttributes
...
func (o *Product202309GetProductResponseDataSkusSalesAttributes) UnmarshalJSON(data []byte) (err error) {
    varProduct202309GetProductResponseDataSkusSalesAttributes := _Product202309GetProductResponseDataSkusSalesAttributes{}

    err = json.Unmarshal(data, &varProduct202309GetProductResponseDataSkusSalesAttributes)

    if err != nil {
        return err
    }

    *o = Product202309GetProductResponseDataSkusSalesAttributes(varProduct202309GetProductResponseDataSkusSalesAttributes)
