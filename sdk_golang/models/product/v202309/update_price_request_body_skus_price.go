...
type _Product202309UpdatePriceRequestBodySkusPrice Product202309UpdatePriceRequestBodySkusPrice
...
func (o *Product202309UpdatePriceRequestBodySkusPrice) UnmarshalJSON(data []byte) (err error) {
    varProduct202309UpdatePriceRequestBodySkusPrice := _Product202309UpdatePriceRequestBodySkusPrice{}

    err = json.Unmarshal(data, &varProduct202309UpdatePriceRequestBodySkusPrice)

    if err != nil {
        return err
    }

    *o = Product202309UpdatePriceRequestBodySkusPrice(varProduct202309UpdatePriceRequestBodySkusPrice)
