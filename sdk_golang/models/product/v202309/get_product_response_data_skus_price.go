...
type _Product202309GetProductResponseDataSkusPrice Product202309GetProductResponseDataSkusPrice
...
func (o *Product202309GetProductResponseDataSkusPrice) UnmarshalJSON(data []byte) (err error) {
    varProduct202309GetProductResponseDataSkusPrice := _Product202309GetProductResponseDataSkusPrice{}

    err = json.Unmarshal(data, &varProduct202309GetProductResponseDataSkusPrice)

    if err != nil {
        return err
    }

    *o = Product202309GetProductResponseDataSkusPrice(varProduct202309GetProductResponseDataSkusPrice)
