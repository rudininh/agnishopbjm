...
type _Product202309CheckListingPrerequisitesResponseDataShop Product202309CheckListingPrerequisitesResponseDataShop
...
func (o *Product202309CheckListingPrerequisitesResponseDataShop) UnmarshalJSON(data []byte) (err error) {
    varProduct202309CheckListingPrerequisitesResponseDataShop := _Product202309CheckListingPrerequisitesResponseDataShop{}

    err = json.Unmarshal(data, &varProduct202309CheckListingPrerequisitesResponseDataShop)

    if err != nil {
        return err
    }

    *o = Product202309CheckListingPrerequisitesResponseDataShop(varProduct202309CheckListingPrerequisitesResponseDataShop)
    ...
    if err = json.Unmarshal(data, &additionalProperties); err == nil {
        ...
        delete(additionalProperties, "gne")
        delete(additionalProperties, "logistics")
        delete(additionalProperties, "status")
        delete(additionalProperties, "tax_info")
