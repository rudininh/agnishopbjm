...
type _Product202309GetGlobalCategoryRulesResponseDataProductCertifications Product202309GetGlobalCategoryRulesResponseDataProductCertifications
...
func (o *Product202309GetGlobalCategoryRulesResponseDataProductCertifications) UnmarshalJSON(data []byte) (err error) {
    varProduct202309GetGlobalCategoryRulesResponseDataProductCertifications := _Product202309GetGlobalCategoryRulesResponseDataProductCertifications{}

    err = json.Unmarshal(data, &varProduct202309GetGlobalCategoryRulesResponseDataProductCertifications)

    if err != nil {
        return err
    }

    *o = Product202309GetGlobalCategoryRulesResponseDataProductCertifications(varProduct202309GetGlobalCategoryRulesResponseDataProductCertifications)
    ...
    if err = json.Unmarshal(data, &additionalProperties); err == nil {
        ...
        delete(additionalProperties, "requirement_conditions")
        delete(additionalProperties, "sample_image_url")
