...
type _Product202309GetGlobalProductResponseDataMainImages Product202309GetGlobalProductResponseDataMainImages
...
func (o *Product202309GetGlobalProductResponseDataMainImages) UnmarshalJSON(data []byte) (err error) {
    varProduct202309GetGlobalProductResponseDataMainImages := _Product202309GetGlobalProductResponseDataMainImages{}

    err = json.Unmarshal(data, &varProduct202309GetGlobalProductResponseDataMainImages)

    if err != nil {
        return err
    }

    *o = Product202309GetGlobalProductResponseDataMainImages(varProduct202309GetGlobalProductResponseDataMainImages)
