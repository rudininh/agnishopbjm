...
type _Product202309GetBrandsResponseDataBrands Product202309GetBrandsResponseDataBrands
...
func (o *Product202309GetBrandsResponseDataBrands) UnmarshalJSON(data []byte) (err error) {
    varProduct202309GetBrandsResponseDataBrands := _Product202309GetBrandsResponseDataBrands{}

    err = json.Unmarshal(data, &varProduct202309GetBrandsResponseDataBrands)

    if err != nil {
        return err
    }

    *o = Product202309GetBrandsResponseDataBrands(varProduct202309GetBrandsResponseDataBrands)

    additionalProperties := make(map[string]interface{})

    if err = json.Unmarshal(data, &additionalProperties); err == nil {
        delete(additionalProperties, "authorized_status")
        delete(additionalProperties, "brand_status")
        delete(additionalProperties, "id")
        delete(additionalProperties, "is_t1_brand")
