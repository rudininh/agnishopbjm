...
type _Product202309EditProductResponseData Product202309EditProductResponseData
...
func (o *Product202309EditProductResponseData) UnmarshalJSON(data []byte) (err error) {
    varProduct202309EditProductResponseData := _Product202309EditProductResponseData{}

    err = json.Unmarshal(data, &varProduct202309EditProductResponseData)

    if err != nil {
        return err
    }

    *o = Product202309EditProductResponseData(varProduct202309EditProductResponseData)
