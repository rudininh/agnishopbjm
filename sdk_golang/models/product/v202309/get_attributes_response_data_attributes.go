...
type _Product202309GetAttributesResponseDataAttributes Product202309GetAttributesResponseDataAttributes
...
func (o *Product202309GetAttributesResponseDataAttributes) UnmarshalJSON(data []byte) (err error) {
    varProduct202309GetAttributesResponseDataAttributes := _Product202309GetAttributesResponseDataAttributes{}

    err = json.Unmarshal(data, &varProduct202309GetAttributesResponseDataAttributes)

    if err != nil {
        return err
    }

    *o = Product202309GetAttributesResponseDataAttributes(varProduct202309GetAttributesResponseDataAttributes)
    ...
    if err = json.Unmarshal(data, &additionalProperties); err == nil {
        ...
        delete(additionalProperties, "value_data_format")
