...
type _Product202309EditGlobalProductRequestBodySizeChartTemplate Product202309EditGlobalProductRequestBodySizeChartTemplate
...
func (o *Product202309EditGlobalProductRequestBodySizeChartTemplate) UnmarshalJSON(data []byte) (err error) {
    varProduct202309EditGlobalProductRequestBodySizeChartTemplate := _Product202309EditGlobalProductRequestBodySizeChartTemplate{}

    err = json.Unmarshal(data, &varProduct202309EditGlobalProductRequestBodySizeChartTemplate)

    if err != nil {
        return err
    }

    *o = Product202309EditGlobalProductRequestBodySizeChartTemplate(varProduct202309EditGlobalProductRequestBodySizeChartTemplate)
