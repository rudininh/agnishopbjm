...
type _Product202309GetProductResponseDataProductFamilies Product202309GetProductResponseDataProductFamilies
...
func (o *Product202309GetProductResponseDataProductFamilies) UnmarshalJSON(data []byte) (err error) {
    varProduct202309GetProductResponseDataProductFamilies := _Product202309GetProductResponseDataProductFamilies{}

    err = json.Unmarshal(data, &varProduct202309GetProductResponseDataProductFamilies)

    if err != nil {
        return err
    }

    *o = Product202309GetProductResponseDataProductFamilies(varProduct202309GetProductResponseDataProductFamilies)
