...
type _Product202309UpdateInventoryRequestBody Product202309UpdateInventoryRequestBody
...
func (o *Product202309UpdateInventoryRequestBody) UnmarshalJSON(data []byte) (err error) {
    varProduct202309UpdateInventoryRequestBody := _Product202309UpdateInventoryRequestBody{}

    err = json.Unmarshal(data, &varProduct202309UpdateInventoryRequestBody)

    if err != nil {
        return err
    }

    *o = Product202309UpdateInventoryRequestBody(varProduct202309UpdateInventoryRequestBody)
