...
type _Product202309DeactivateProductsResponseData Product202309DeactivateProductsResponseData
...
func (o *Product202309DeactivateProductsResponseData) UnmarshalJSON(data []byte) (err error) {
    varProduct202309DeactivateProductsResponseData := _Product202309DeactivateProductsResponseData{}

    err = json.Unmarshal(data, &varProduct202309DeactivateProductsResponseData)

    if err != nil {
        return err
    }

    *o = Product202309DeactivateProductsResponseData(varProduct202309DeactivateProductsResponseData)
