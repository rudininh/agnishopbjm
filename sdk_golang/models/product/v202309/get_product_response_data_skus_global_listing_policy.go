...
type _Product202309GetProductResponseDataSkusGlobalListingPolicy Product202309GetProductResponseDataSkusGlobalListingPolicy
...
func (o *Product202309GetProductResponseDataSkusGlobalListingPolicy) UnmarshalJSON(data []byte) (err error) {
    varProduct202309GetProductResponseDataSkusGlobalListingPolicy := _Product202309GetProductResponseDataSkusGlobalListingPolicy{}

    err = json.Unmarshal(data, &varProduct202309GetProductResponseDataSkusGlobalListingPolicy)

    if err != nil {
        return err
    }

    *o = Product202309GetProductResponseDataSkusGlobalListingPolicy(varProduct202309GetProductResponseDataSkusGlobalListingPolicy)

    additionalProperties := make(map[string]interface{})

    if err = json.Unmarshal(data, &additionalProperties); err == nil {
        delete(additionalProperties, "inventory_type")
        delete(additionalProperties, "price_sync")
        delete(additionalProperties, "replicate_source")
