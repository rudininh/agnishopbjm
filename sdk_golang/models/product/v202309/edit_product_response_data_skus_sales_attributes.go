...
type _Product202309EditProductResponseDataSkusSalesAttributes Product202309EditProductResponseDataSkusSalesAttributes
...
func (o *Product202309EditProductResponseDataSkusSalesAttributes) UnmarshalJSON(data []byte) (err error) {
    varProduct202309EditProductResponseDataSkusSalesAttributes := _Product202309EditProductResponseDataSkusSalesAttributes{}

    err = json.Unmarshal(data, &varProduct202309EditProductResponseDataSkusSalesAttributes)

    if err != nil {
        return err
    }

    *o = Product202309EditProductResponseDataSkusSalesAttributes(varProduct202309EditProductResponseDataSkusSalesAttributes)
