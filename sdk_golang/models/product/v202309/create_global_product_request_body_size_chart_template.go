...
type _Product202309CreateGlobalProductRequestBodySizeChartTemplate Product202309CreateGlobalProductRequestBodySizeChartTemplate
...
func (o *Product202309CreateGlobalProductRequestBodySizeChartTemplate) UnmarshalJSON(data []byte) (err error) {
    varProduct202309CreateGlobalProductRequestBodySizeChartTemplate := _Product202309CreateGlobalProductRequestBodySizeChartTemplate{}

    err = json.Unmarshal(data, &varProduct202309CreateGlobalProductRequestBodySizeChartTemplate)

    if err != nil {
        return err
    }

    *o = Product202309CreateGlobalProductRequestBodySizeChartTemplate(varProduct202309CreateGlobalProductRequestBodySizeChartTemplate)
