...
type _Product202309DeleteGlobalProductsResponseDataErrors Product202309DeleteGlobalProductsResponseDataErrors
...
func (o *Product202309DeleteGlobalProductsResponseDataErrors) UnmarshalJSON(data []byte) (err error) {
    varProduct202309DeleteGlobalProductsResponseDataErrors := _Product202309DeleteGlobalProductsResponseDataErrors{}

    err = json.Unmarshal(data, &varProduct202309DeleteGlobalProductsResponseDataErrors)

    if err != nil {
        return err
    }

    *o = Product202309DeleteGlobalProductsResponseDataErrors(varProduct202309DeleteGlobalProductsResponseDataErrors)
