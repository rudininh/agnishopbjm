...
type Product202309SearchProductsResponseDataProductsSkus struct {
    ...
    Fees []Product202309SearchProductsResponseDataProductsSkusFees `json:"fees,omitempty"`
...
type _Product202309SearchProductsResponseDataProductsSkus Product202309SearchProductsResponseDataProductsSkus
...
func (o *Product202309SearchProductsResponseDataProductsSkus) GetFees() []Product202309SearchProductsResponseDataProductsSkusFees {
    if o == nil || utils.IsNil(o.Fees) {
        var ret []Product202309SearchProductsResponseDataProductsSkusFees
        return ret
    }
    return o.Fees
}
...
func (o *Product202309SearchProductsResponseDataProductsSkus) GetFeesOk() ([]Product202309SearchProductsResponseDataProductsSkusFees, bool) {
    if o == nil || utils.IsNil(o.Fees) {
        return nil, false
    }
    return o.Fees, true
...
func (o *Product202309SearchProductsResponseDataProductsSkus) HasFees() bool {
    if o != nil && !utils.IsNil(o.Fees) {
        return true
    }
...
// SetFees gets a reference to the given []Product202309SearchProductsResponseDataProductsSkusFees and assigns it to the Fees field.
func (o *Product202309SearchProductsResponseDataProductsSkus) SetFees(v []Product202309SearchProductsResponseDataProductsSkusFees) {
    o.Fees = v
}
...
func (o *Product202309SearchProductsResponseDataProductsSkus) UnmarshalJSON(data []byte) (err error) {
    varProduct202309SearchProductsResponseDataProductsSkus := _Product202309SearchProductsResponseDataProductsSkus{}

    err = json.Unmarshal(data, &varProduct202309SearchProductsResponseDataProductsSkus)

    if err != nil {
        return err
    }

    *o = Product202309SearchProductsResponseDataProductsSkus(varProduct202309SearchProductsResponseDataProductsSkus)
