...
// NewProduct202309PartialEditProductRequestBodyPackageDimensions instantiates a new Product202309PartialEditProductRequestBodyPackageDimensions object
...
type NullableProduct202309PartialEditProductRequestBodyPackageDimensions struct {
	value *Product202309PartialEditProductRequestBodyPackageDimensions
	isSet bool
}

func (v NullableProduct202309PartialEditProductRequestBodyPackageDimensions) Get() *Product202309PartialEditProductRequestBodyPackageDimensions {
	return v.value
}

func (v *NullableProduct202309PartialEditProductRequestBodyPackageDimensions) Set(val *Product202309PartialEditProductRequestBodyPackageDimensions) {
	v.value = val
	v.isSet = true
}

func (v NullableProduct202309PartialEditProductRequestBodyPackageDimensions) IsSet() bool {
	return v.isSet
}

func (v *NullableProduct202309PartialEditProductRequestBodyPackageDimensions) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableProduct202309PartialEditProductRequestBodyPackageDimensions(val *Product202309PartialEditProductRequestBodyPackageDimensions) *NullableProduct202309PartialEditProductRequestBodyPackageDimensions {
	return &NullableProduct202309PartialEditProductRequestBodyPackageDimensions{value: val, isSet: true}
}

func (v NullableProduct202309PartialEditProductRequestBodyPackageDimensions) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableProduct202309PartialEditProductRequestBodyPackageDimensions) UnmarshalJSON(src []byte) error {
	v.isSet = true
