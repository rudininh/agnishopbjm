...
type _Product202309CreateProductRequestBodyCertificationsImages Product202309CreateProductRequestBodyCertificationsImages
...
func (o *Product202309CreateProductRequestBodyCertificationsImages) UnmarshalJSON(data []byte) (err error) {
    varProduct202309CreateProductRequestBodyCertificationsImages := _Product202309CreateProductRequestBodyCertificationsImages{}

    err = json.Unmarshal(data, &varProduct202309CreateProductRequestBodyCertificationsImages)

    if err != nil {
        return err
    }

    *o = Product202309CreateProductRequestBodyCertificationsImages(varProduct202309CreateProductRequestBodyCertificationsImages)
