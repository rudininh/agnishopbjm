...
type _Product202309PublishGlobalProductRequestBodyPublishTarget Product202309PublishGlobalProductRequestBodyPublishTarget
...
func (o *Product202309PublishGlobalProductRequestBodyPublishTarget) UnmarshalJSON(data []byte) (err error) {
    varProduct202309PublishGlobalProductRequestBodyPublishTarget := _Product202309PublishGlobalProductRequestBodyPublishTarget{}

    err = json.Unmarshal(data, &varProduct202309PublishGlobalProductRequestBodyPublishTarget)

    if err != nil {
        return err
    }

    *o = Product202309PublishGlobalProductRequestBodyPublishTarget(varProduct202309PublishGlobalProductRequestBodyPublishTarget)
