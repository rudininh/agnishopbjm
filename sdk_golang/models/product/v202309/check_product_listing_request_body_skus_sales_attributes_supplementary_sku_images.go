...
type _Product202309CheckProductListingRequestBodySkusSalesAttributesSupplementarySkuImages Product202309CheckProductListingRequestBodySkusSalesAttributesSupplementarySkuImages
...
func (o *Product202309CheckProductListingRequestBodySkusSalesAttributesSupplementarySkuImages) UnmarshalJSON(data []byte) (err error) {
    varProduct202309CheckProductListingRequestBodySkusSalesAttributesSupplementarySkuImages := _Product202309CheckProductListingRequestBodySkusSalesAttributesSupplementarySkuImages{}

    err = json.Unmarshal(data, &varProduct202309CheckProductListingRequestBodySkusSalesAttributesSupplementarySkuImages)

    if err != nil {
        return err
    }

    *o = Product202309CheckProductListingRequestBodySkusSalesAttributesSupplementarySkuImages(varProduct202309CheckProductListingRequestBodySkusSalesAttributesSupplementarySkuImages)
