...
type _Product202309SearchProductsResponseDataProductsSkusPrice Product202309SearchProductsResponseDataProductsSkusPrice
...
func (o *Product202309SearchProductsResponseDataProductsSkusPrice) UnmarshalJSON(data []byte) (err error) {
    varProduct202309SearchProductsResponseDataProductsSkusPrice := _Product202309SearchProductsResponseDataProductsSkusPrice{}

    err = json.Unmarshal(data, &varProduct202309SearchProductsResponseDataProductsSkusPrice)

    if err != nil {
        return err
    }

    *o = Product202309SearchProductsResponseDataProductsSkusPrice(varProduct202309SearchProductsResponseDataProductsSkusPrice)
