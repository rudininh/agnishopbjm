...
type _Product202409PartialEditResponsiblePersonRequestBodyAddress Product202409PartialEditResponsiblePersonRequestBodyAddress
...
func (o *Product202409PartialEditResponsiblePersonRequestBodyAddress) UnmarshalJSON(data []byte) (err error) {
    varProduct202409PartialEditResponsiblePersonRequestBodyAddress := _Product202409PartialEditResponsiblePersonRequestBodyAddress{}

    err = json.Unmarshal(data, &varProduct202409PartialEditResponsiblePersonRequestBodyAddress)

    if err != nil {
        return err
    }

    *o = Product202409PartialEditResponsiblePersonRequestBodyAddress(varProduct202409PartialEditResponsiblePersonRequestBodyAddress)
