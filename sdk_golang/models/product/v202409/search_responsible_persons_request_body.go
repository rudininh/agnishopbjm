...
type _Product202409SearchResponsiblePersonsRequestBody Product202409SearchResponsiblePersonsRequestBody
...
func (o *Product202409SearchResponsiblePersonsRequestBody) UnmarshalJSON(data []byte) (err error) {
    varProduct202409SearchResponsiblePersonsRequestBody := _Product202409SearchResponsiblePersonsRequestBody{}

    err = json.Unmarshal(data, &varProduct202409SearchResponsiblePersonsRequestBody)

    if err != nil {
        return err
    }

    *o = Product202409SearchResponsiblePersonsRequestBody(varProduct202409SearchResponsiblePersonsRequestBody)
