...
type _Product202404OptimizedImagesResponse Product202404OptimizedImagesResponse
...
func (o *Product202404OptimizedImagesResponse) UnmarshalJSON(data []byte) (err error) {
    varProduct202404OptimizedImagesResponse := _Product202404OptimizedImagesResponse{}

    err = json.Unmarshal(data, &varProduct202404OptimizedImagesResponse)

    if err != nil {
        return err
    }

    *o = Product202404OptimizedImagesResponse(varProduct202404OptimizedImagesResponse)
