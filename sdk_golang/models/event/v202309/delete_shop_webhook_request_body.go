...
type _Event202309DeleteShopWebhookRequestBody Event202309DeleteShopWebhookRequestBody
...
func (o *Event202309DeleteShopWebhookRequestBody) UnmarshalJSON(data []byte) (err error) {
    varEvent202309DeleteShopWebhookRequestBody := _Event202309DeleteShopWebhookRequestBody{}

    err = json.Unmarshal(data, &varEvent202309DeleteShopWebhookRequestBody)

    if err != nil {
        return err
    }

    *o = Event202309DeleteShopWebhookRequestBody(varEvent202309DeleteShopWebhookRequestBody)
