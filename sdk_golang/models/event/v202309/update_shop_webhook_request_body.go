...
import (
    ...
    "agnishopbjm/sdk_golang/utils"
            ...
            // checks if the Event202309UpdateShopWebhookRequestBody type satisfies the MappedNullable interface at compile time
var _ utils.MappedNullable = &Event202309UpdateShopWebhookRequestBody{}

// Event202309UpdateShopWebhookRequestBody struct for Event202309UpdateShopWebhookRequestBody
type Event202309UpdateShopWebhookRequestBody struct {
...
type _Event202309UpdateShopWebhookRequestBody Event202309UpdateShopWebhookRequestBody

// NewEvent202309UpdateShopWebhookRequestBody instantiates a new Event202309UpdateShopWebhookRequestBody object
// This constructor will assign default values to properties that have it defined,
// and makes sure properties required by API are set, but the set of arguments
// will change when the set of required properties is changed
func NewEvent202309UpdateShopWebhookRequestBody() *Event202309UpdateShopWebhookRequestBody {
    this := Event202309UpdateShopWebhookRequestBody{}
    return &this
}

// NewEvent202309UpdateShopWebhookRequestBodyWithDefaults instantiates a new Event202309UpdateShopWebhookRequestBody object
// This constructor will only assign default values to properties that have it defined,
// but it doesn't guarantee that properties required by API are set
func NewEvent202309UpdateShopWebhookRequestBodyWithDefaults() *Event202309UpdateShopWebhookRequestBody {
    this := Event202309UpdateShopWebhookRequestBody{}
    return &this
}

// GetAddress returns the Address field value if set, zero value otherwise.
func (o *Event202309UpdateShopWebhookRequestBody) GetAddress() string {
...
func (o *Event202309UpdateShopWebhookRequestBody) GetAddressOk() (*string, bool) {
    if o == nil || utils.IsNil(o.Address) {
        return nil, false
    }
...
func (o *Event202309UpdateShopWebhookRequestBody) HasAddress() bool {
    if o != nil && !utils.IsNil(o.Address) {
        return true
    }
...
func (o *Event202309UpdateShopWebhookRequestBody) SetAddress(v string) {
    o.Address = &v
}

// GetEventType returns the EventType field value if set, zero value otherwise.
func (o *Event202309UpdateShopWebhookRequestBody) GetEventType() string {
...
// and a boolean to check if the value has been set.
func (o *Event202309UpdateShopWebhookRequestBody) GetEventTypeOk() (*string, bool) {
    if o == nil || utils.IsNil(o.EventType) {
        return nil, false
    }
...
func (o *Event202309UpdateShopWebhookRequestBody) HasEventType() bool {
    if o != nil && !utils.IsNil(o.EventType) {
        return true
    }
...
func (o *Event202309UpdateShopWebhookRequestBody) SetEventType(v string) {
    o.EventType = &v
}

func (o Event202309UpdateShopWebhookRequestBody) MarshalJSON() ([]byte, error) {
...
func (o Event202309UpdateShopWebhookRequestBody) ToMap() (map[string]interface{}, error) {
...
func (o *Event202309UpdateShopWebhookRequestBody) UnmarshalJSON(data []byte) (err error) {
    varEvent202309UpdateShopWebhookRequestBody := _Event202309UpdateShopWebhookRequestBody{}

    err = json.Unmarshal(data, &varEvent202309UpdateShopWebhookRequestBody)

    if err != nil {
        return err
    }

    *o = Event202309UpdateShopWebhookRequestBody(varEvent202309UpdateShopWebhookRequestBody)
...
type NullableEvent202309UpdateShopWebhookRequestBody struct {
	value *Event202309UpdateShopWebhookRequestBody
	isSet bool
}

func (v NullableEvent202309UpdateShopWebhookRequestBody) Get() *Event202309UpdateShopWebhookRequestBody {
	return v.value
}

func (v *NullableEvent202309UpdateShopWebhookRequestBody) Set(val *Event202309UpdateShopWebhookRequestBody) {
	v.value = val
	v.isSet = true
}

func (v NullableEvent202309UpdateShopWebhookRequestBody) IsSet() bool {
	return v.isSet
}

func (v *NullableEvent202309UpdateShopWebhookRequestBody) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableEvent202309UpdateShopWebhookRequestBody(val *Event202309UpdateShopWebhookRequestBody) *NullableEvent202309UpdateShopWebhookRequestBody {
	return &NullableEvent202309UpdateShopWebhookRequestBody{value: val, isSet: true}
}

func (v NullableEvent202309UpdateShopWebhookRequestBody) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableEvent202309UpdateShopWebhookRequestBody) UnmarshalJSON(src []byte) error {
	v.isSet = true
