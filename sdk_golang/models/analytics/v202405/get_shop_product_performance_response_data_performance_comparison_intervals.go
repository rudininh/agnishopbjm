...
type _Analytics202405GetShopProductPerformanceResponseDataPerformanceComparisonIntervals Analytics202405GetShopProductPerformanceResponseDataPerformanceComparisonIntervals
...
func (o *Analytics202405GetShopProductPerformanceResponseDataPerformanceComparisonIntervals) UnmarshalJSON(data []byte) (err error) {
    varAnalytics202405GetShopProductPerformanceResponseDataPerformanceComparisonIntervals := _Analytics202405GetShopProductPerformanceResponseDataPerformanceComparisonIntervals{}

    err = json.Unmarshal(data, &varAnalytics202405GetShopProductPerformanceResponseDataPerformanceComparisonIntervals)

    if err != nil {
        return err
    }

    *o = Analytics202405GetShopProductPerformanceResponseDataPerformanceComparisonIntervals(varAnalytics202405GetShopProductPerformanceResponseDataPerformanceComparisonIntervals)

    additionalProperties := make(map[string]interface{})

    if err = json.Unmarshal(data, &additionalProperties); err == nil {
        delete(additionalProperties, "avg_page_visitor_breakdowns")
        delete(additionalProperties, "avg_page_visitors")
        delete(additionalProperties, "click_through_rate")
        delete(additionalProperties, "click_through_rate_breakdowns")
        delete(additionalProperties, "end_date")
        delete(additionalProperties, "gmv")
        delete(additionalProperties, "gmv_breakdowns")
        delete(additionalProperties, "impression_breakdowns")
        delete(additionalProperties, "impressions")
        delete(additionalProperties, "orders")
        delete(additionalProperties, "page_view_breakdowns")
        delete(additionalProperties, "page_views")
        delete(additionalProperties, "start_date")
        delete(additionalProperties, "unit_sold_breakdowns")
