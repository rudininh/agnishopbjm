...
type _Analytics202405GetShopProductPerformanceListResponse Analytics202405GetShopProductPerformanceListResponse
...
func (o *Analytics202405GetShopProductPerformanceListResponse) UnmarshalJSON(data []byte) (err error) {
    varAnalytics202405GetShopProductPerformanceListResponse := _Analytics202405GetShopProductPerformanceListResponse{}

    err = json.Unmarshal(data, &varAnalytics202405GetShopProductPerformanceListResponse)

    if err != nil {
        return err
    }

    *o = Analytics202405GetShopProductPerformanceListResponse(varAnalytics202405GetShopProductPerformanceListResponse)
