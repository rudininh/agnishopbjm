...
type _Analytics202405GetShopProductPerformanceResponseDataPerformanceIntervals Analytics202405GetShopProductPerformanceResponseDataPerformanceIntervals
...
func (o *Analytics202405GetShopProductPerformanceResponseDataPerformanceIntervals) UnmarshalJSON(data []byte) (err error) {
    varAnalytics202405GetShopProductPerformanceResponseDataPerformanceIntervals := _Analytics202405GetShopProductPerformanceResponseDataPerformanceIntervals{}

    err = json.Unmarshal(data, &varAnalytics202405GetShopProductPerformanceResponseDataPerformanceIntervals)

    if err != nil {
        return err
    }

    *o = Analytics202405GetShopProductPerformanceResponseDataPerformanceIntervals(varAnalytics202405GetShopProductPerformanceResponseDataPerformanceIntervals)
