...
type _Analytics202406GetShopSKUPerformanceListResponse Analytics202406GetShopSKUPerformanceListResponse
...
func (o *Analytics202406GetShopSKUPerformanceListResponse) UnmarshalJSON(data []byte) (err error) {
    varAnalytics202406GetShopSKUPerformanceListResponse := _Analytics202406GetShopSKUPerformanceListResponse{}

    err = json.Unmarshal(data, &varAnalytics202406GetShopSKUPerformanceListResponse)

    if err != nil {
        return err
    }

    *o = Analytics202406GetShopSKUPerformanceListResponse(varAnalytics202406GetShopSKUPerformanceListResponse)
