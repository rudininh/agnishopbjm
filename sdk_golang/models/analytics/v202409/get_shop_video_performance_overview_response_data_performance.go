...
type _Analytics202409GetShopVideoPerformanceOverviewResponseDataPerformance Analytics202409GetShopVideoPerformanceOverviewResponseDataPerformance
...
func (o *Analytics202409GetShopVideoPerformanceOverviewResponseDataPerformance) UnmarshalJSON(data []byte) (err error) {
    varAnalytics202409GetShopVideoPerformanceOverviewResponseDataPerformance := _Analytics202409GetShopVideoPerformanceOverviewResponseDataPerformance{}

    err = json.Unmarshal(data, &varAnalytics202409GetShopVideoPerformanceOverviewResponseDataPerformance)

    if err != nil {
        return err
    }

    *o = Analytics202409GetShopVideoPerformanceOverviewResponseDataPerformance(varAnalytics202409GetShopVideoPerformanceOverviewResponseDataPerformance)
