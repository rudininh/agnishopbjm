...
type _Finance202507GetUnsettledTransactionsResponseDataTransactions Finance202507GetUnsettledTransactionsResponseDataTransactions
...
func (o *Finance202507GetUnsettledTransactionsResponseDataTransactions) UnmarshalJSON(data []byte) (err error) {
    varFinance202507GetUnsettledTransactionsResponseDataTransactions := _Finance202507GetUnsettledTransactionsResponseDataTransactions{}

    err = json.Unmarshal(data, &varFinance202507GetUnsettledTransactionsResponseDataTransactions)

    if err != nil {
        return err
    }

    *o = Finance202507GetUnsettledTransactionsResponseDataTransactions(varFinance202507GetUnsettledTransactionsResponseDataTransactions)
    ...
    if err = json.Unmarshal(data, &additionalProperties); err == nil {
        ...
        delete(additionalProperties, "est_adjustment_amount")
        delete(additionalProperties, "est_fee_tax_amount")
        delete(additionalProperties, "est_revenue_amount")
        delete(additionalProperties, "est_settlement_amount")
        delete(additionalProperties, "est_shipping_cost_amount")
        delete(additionalProperties, "estimated_settlement")
        delete(additionalProperties, "fee_tax_breakdown")
        delete(additionalProperties, "id")
        delete(additionalProperties, "order_create_time")
        delete(additionalProperties, "order_delivery_time")
        ...
        delete(additionalProperties, "unsettled_reason")
