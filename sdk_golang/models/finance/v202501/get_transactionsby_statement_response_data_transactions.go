...
type _Finance202501GetTransactionsbyStatementResponseDataTransactions Finance202501GetTransactionsbyStatementResponseDataTransactions
...
func (o *Finance202501GetTransactionsbyStatementResponseDataTransactions) UnmarshalJSON(data []byte) (err error) {
    varFinance202501GetTransactionsbyStatementResponseDataTransactions := _Finance202501GetTransactionsbyStatementResponseDataTransactions{}

    err = json.Unmarshal(data, &varFinance202501GetTransactionsbyStatementResponseDataTransactions)

    if err != nil {
        return err
    }

    *o = Finance202501GetTransactionsbyStatementResponseDataTransactions(varFinance202501GetTransactionsbyStatementResponseDataTransactions)
    ...
    if err = json.Unmarshal(data, &additionalProperties); err == nil {
        ...
        delete(additionalProperties, "associated_order_id")
        delete(additionalProperties, "estimated_release_time")
        delete(additionalProperties, "fee_tax_amount")
        delete(additionalProperties, "fee_tax_breakdown")
        delete(additionalProperties, "id")
        delete(additionalProperties, "order_create_time")
        delete(additionalProperties, "order_id")
        delete(additionalProperties, "reserve_amount")
        delete(additionalProperties, "reserve_id")
        delete(additionalProperties, "reserve_status")
        delete(additionalProperties, "revenue_amount")
        delete(additionalProperties, "revenue_breakdown")
        delete(additionalProperties, "settlement_amount")
        delete(additionalProperties, "shipping_cost_amount")
        delete(additionalProperties, "shipping_cost_breakdown")
