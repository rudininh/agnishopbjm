...
type _Finance202501GetTransactionsbyOrderResponseDataSkuTransactionsRevenueBreakdown Finance202501GetTransactionsbyOrderResponseDataSkuTransactionsRevenueBreakdown
...
func (o *Finance202501GetTransactionsbyOrderResponseDataSkuTransactionsRevenueBreakdown) UnmarshalJSON(data []byte) (err error) {
    varFinance202501GetTransactionsbyOrderResponseDataSkuTransactionsRevenueBreakdown := _Finance202501GetTransactionsbyOrderResponseDataSkuTransactionsRevenueBreakdown{}

    err = json.Unmarshal(data, &varFinance202501GetTransactionsbyOrderResponseDataSkuTransactionsRevenueBreakdown)

    if err != nil {
        return err
    }

    *o = Finance202501GetTransactionsbyOrderResponseDataSkuTransactionsRevenueBreakdown(varFinance202501GetTransactionsbyOrderResponseDataSkuTransactionsRevenueBreakdown)
