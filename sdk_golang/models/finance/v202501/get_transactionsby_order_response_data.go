...
type _Finance202501GetTransactionsbyOrderResponseData Finance202501GetTransactionsbyOrderResponseData
...
func (o *Finance202501GetTransactionsbyOrderResponseData) UnmarshalJSON(data []byte) (err error) {
    varFinance202501GetTransactionsbyOrderResponseData := _Finance202501GetTransactionsbyOrderResponseData{}

    err = json.Unmarshal(data, &varFinance202501GetTransactionsbyOrderResponseData)

    if err != nil {
        return err
    }

    *o = Finance202501GetTransactionsbyOrderResponseData(varFinance202501GetTransactionsbyOrderResponseData)

    additionalProperties := make(map[string]interface{})

    if err = json.Unmarshal(data, &additionalProperties); err == nil {
        delete(additionalProperties, "currency")
        delete(additionalProperties, "fee_and_tax_amount")
        ...
        delete(additionalProperties, "sku_transactions")
