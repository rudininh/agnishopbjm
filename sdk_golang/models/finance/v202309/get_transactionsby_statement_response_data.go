...
type _Finance202309GetTransactionsbyStatementResponseData Finance202309GetTransactionsbyStatementResponseData
...
func (o *Finance202309GetTransactionsbyStatementResponseData) UnmarshalJSON(data []byte) (err error) {
    varFinance202309GetTransactionsbyStatementResponseData := _Finance202309GetTransactionsbyStatementResponseData{}

    err = json.Unmarshal(data, &varFinance202309GetTransactionsbyStatementResponseData)

    if err != nil {
        return err
    }

    *o = Finance202309GetTransactionsbyStatementResponseData(varFinance202309GetTransactionsbyStatementResponseData)
