...
type _Finance202309GetWithdrawalsResponseDataWithdrawals Finance202309GetWithdrawalsResponseDataWithdrawals
...
func (o *Finance202309GetWithdrawalsResponseDataWithdrawals) UnmarshalJSON(data []byte) (err error) {
    varFinance202309GetWithdrawalsResponseDataWithdrawals := _Finance202309GetWithdrawalsResponseDataWithdrawals{}

    err = json.Unmarshal(data, &varFinance202309GetWithdrawalsResponseDataWithdrawals)

    if err != nil {
        return err
    }

    *o = Finance202309GetWithdrawalsResponseDataWithdrawals(varFinance202309GetWithdrawalsResponseDataWithdrawals)
