...
type _Finance202309GetPaymentsResponseData Finance202309GetPaymentsResponseData
...
func (o *Finance202309GetPaymentsResponseData) UnmarshalJSON(data []byte) (err error) {
    varFinance202309GetPaymentsResponseData := _Finance202309GetPaymentsResponseData{}

    err = json.Unmarshal(data, &varFinance202309GetPaymentsResponseData)

    if err != nil {
        return err
    }

    *o = Finance202309GetPaymentsResponseData(varFinance202309GetPaymentsResponseData)
