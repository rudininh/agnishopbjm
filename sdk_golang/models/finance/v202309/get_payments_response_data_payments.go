...
type _Finance202309GetPaymentsResponseDataPayments Finance202309GetPaymentsResponseDataPayments
...
func (o *Finance202309GetPaymentsResponseDataPayments) UnmarshalJSON(data []byte) (err error) {
    varFinance202309GetPaymentsResponseDataPayments := _Finance202309GetPaymentsResponseDataPayments{}

    err = json.Unmarshal(data, &varFinance202309GetPaymentsResponseDataPayments)

    if err != nil {
        return err
    }

    *o = Finance202309GetPaymentsResponseDataPayments(varFinance202309GetPaymentsResponseDataPayments)
    ...
    if err = json.Unmarshal(data, &additionalProperties); err == nil {
        ...
        delete(additionalProperties, "payment_amount_before_exchange")
