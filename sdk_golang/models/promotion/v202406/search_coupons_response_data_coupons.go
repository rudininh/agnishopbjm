...
type _Promotion202406SearchCouponsResponseDataCoupons Promotion202406SearchCouponsResponseDataCoupons
...
func (o *Promotion202406SearchCouponsResponseDataCoupons) UnmarshalJSON(data []byte) (err error) {
    varPromotion202406SearchCouponsResponseDataCoupons := _Promotion202406SearchCouponsResponseDataCoupons{}

    err = json.Unmarshal(data, &varPromotion202406SearchCouponsResponseDataCoupons)

    if err != nil {
        return err
    }

    *o = Promotion202406SearchCouponsResponseDataCoupons(varPromotion202406SearchCouponsResponseDataCoupons)
