...
// NewPromotion202406SearchCouponsResponseDataCouponsDiscount instantiates a new Promotion202406SearchCouponsResponseDataCouponsDiscount object
...
type NullablePromotion202406SearchCouponsResponseDataCouponsDiscount struct {
	value *Promotion202406SearchCouponsResponseDataCouponsDiscount
	isSet bool
}

func (v NullablePromotion202406SearchCouponsResponseDataCouponsDiscount) Get() *Promotion202406SearchCouponsResponseDataCouponsDiscount {
	return v.value
}

func (v *NullablePromotion202406SearchCouponsResponseDataCouponsDiscount) Set(val *Promotion202406SearchCouponsResponseDataCouponsDiscount) {
	v.value = val
	v.isSet = true
}

func (v NullablePromotion202406SearchCouponsResponseDataCouponsDiscount) IsSet() bool {
	return v.isSet
}

func (v *NullablePromotion202406SearchCouponsResponseDataCouponsDiscount) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePromotion202406SearchCouponsResponseDataCouponsDiscount(val *Promotion202406SearchCouponsResponseDataCouponsDiscount) *NullablePromotion202406SearchCouponsResponseDataCouponsDiscount {
	return &NullablePromotion202406SearchCouponsResponseDataCouponsDiscount{value: val, isSet: true}
}

func (v NullablePromotion202406SearchCouponsResponseDataCouponsDiscount) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePromotion202406SearchCouponsResponseDataCouponsDiscount) UnmarshalJSON(src []byte) error {
	v.isSet = true
