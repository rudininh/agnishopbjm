...
type _Promotion202309GetActivityResponseDataProductsSkus Promotion202309GetActivityResponseDataProductsSkus
...
func (o *Promotion202309GetActivityResponseDataProductsSkus) UnmarshalJSON(data []byte) (err error) {
    varPromotion202309GetActivityResponseDataProductsSkus := _Promotion202309GetActivityResponseDataProductsSkus{}

    err = json.Unmarshal(data, &varPromotion202309GetActivityResponseDataProductsSkus)

    if err != nil {
        return err
    }

    *o = Promotion202309GetActivityResponseDataProductsSkus(varPromotion202309GetActivityResponseDataProductsSkus)

    additionalProperties := make(map[string]interface{})

    if err = json.Unmarshal(data, &additionalProperties); err == nil {
        delete(additionalProperties, "activity_price")
