...
type _Promotion202309UpdateActivityProductRequestBodyProducts Promotion202309UpdateActivityProductRequestBodyProducts
...
func (o *Promotion202309UpdateActivityProductRequestBodyProducts) UnmarshalJSON(data []byte) (err error) {
    varPromotion202309UpdateActivityProductRequestBodyProducts := _Promotion202309UpdateActivityProductRequestBodyProducts{}

    err = json.Unmarshal(data, &varPromotion202309UpdateActivityProductRequestBodyProducts)

    if err != nil {
        return err
    }

    *o = Promotion202309UpdateActivityProductRequestBodyProducts(varPromotion202309UpdateActivityProductRequestBodyProducts)
