...
type _Fulfillment202309MarkPackageAsShippedResponseData Fulfillment202309MarkPackageAsShippedResponseData
...
func (o *Fulfillment202309MarkPackageAsShippedResponseData) UnmarshalJSON(data []byte) (err error) {
    varFulfillment202309MarkPackageAsShippedResponseData := _Fulfillment202309MarkPackageAsShippedResponseData{}

    err = json.Unmarshal(data, &varFulfillment202309MarkPackageAsShippedResponseData)

    if err != nil {
        return err
    }

    *o = Fulfillment202309MarkPackageAsShippedResponseData(varFulfillment202309MarkPackageAsShippedResponseData)
