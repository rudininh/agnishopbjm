...
type _Fulfillment202309SearchCombinablePackagesResponseDataCombinablePackages Fulfillment202309SearchCombinablePackagesResponseDataCombinablePackages
...
func (o *Fulfillment202309SearchCombinablePackagesResponseDataCombinablePackages) UnmarshalJSON(data []byte) (err error) {
    varFulfillment202309SearchCombinablePackagesResponseDataCombinablePackages := _Fulfillment202309SearchCombinablePackagesResponseDataCombinablePackages{}

    err = json.Unmarshal(data, &varFulfillment202309SearchCombinablePackagesResponseDataCombinablePackages)

    if err != nil {
        return err
    }

    *o = Fulfillment202309SearchCombinablePackagesResponseDataCombinablePackages(varFulfillment202309SearchCombinablePackagesResponseDataCombinablePackages)
