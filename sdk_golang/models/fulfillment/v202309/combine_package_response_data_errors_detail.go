...
type _Fulfillment202309CombinePackageResponseDataErrorsDetail Fulfillment202309CombinePackageResponseDataErrorsDetail
...
func (o *Fulfillment202309CombinePackageResponseDataErrorsDetail) UnmarshalJSON(data []byte) (err error) {
    varFulfillment202309CombinePackageResponseDataErrorsDetail := _Fulfillment202309CombinePackageResponseDataErrorsDetail{}

    err = json.Unmarshal(data, &varFulfillment202309CombinePackageResponseDataErrorsDetail)

    if err != nil {
        return err
    }

    *o = Fulfillment202309CombinePackageResponseDataErrorsDetail(varFulfillment202309CombinePackageResponseDataErrorsDetail)
