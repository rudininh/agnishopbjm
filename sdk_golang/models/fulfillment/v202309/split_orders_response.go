...
type _Fulfillment202309SplitOrdersResponse Fulfillment202309SplitOrdersResponse
...
func (o *Fulfillment202309SplitOrdersResponse) UnmarshalJSON(data []byte) (err error) {
    varFulfillment202309SplitOrdersResponse := _Fulfillment202309SplitOrdersResponse{}

    err = json.Unmarshal(data, &varFulfillment202309SplitOrdersResponse)

    if err != nil {
        return err
    }

    *o = Fulfillment202309SplitOrdersResponse(varFulfillment202309SplitOrdersResponse)
