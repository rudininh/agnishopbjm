...
type _Fulfillment202309ShipPackageRequestBodySelfShipment Fulfillment202309ShipPackageRequestBodySelfShipment
...
func (o *Fulfillment202309ShipPackageRequestBodySelfShipment) UnmarshalJSON(data []byte) (err error) {
    varFulfillment202309ShipPackageRequestBodySelfShipment := _Fulfillment202309ShipPackageRequestBodySelfShipment{}

    err = json.Unmarshal(data, &varFulfillment202309ShipPackageRequestBodySelfShipment)

    if err != nil {
        return err
    }

    *o = Fulfillment202309ShipPackageRequestBodySelfShipment(varFulfillment202309ShipPackageRequestBodySelfShipment)
