...
type _Fulfillment202309ShipPackageResponse Fulfillment202309ShipPackageResponse
...
func (o *Fulfillment202309ShipPackageResponse) UnmarshalJSON(data []byte) (err error) {
    varFulfillment202309ShipPackageResponse := _Fulfillment202309ShipPackageResponse{}

    err = json.Unmarshal(data, &varFulfillment202309ShipPackageResponse)

    if err != nil {
        return err
    }

    *o = Fulfillment202309ShipPackageResponse(varFulfillment202309ShipPackageResponse)
