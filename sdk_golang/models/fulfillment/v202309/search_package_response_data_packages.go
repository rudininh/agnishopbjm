...
type _Fulfillment202309SearchPackageResponseDataPackages Fulfillment202309SearchPackageResponseDataPackages
...
func (o *Fulfillment202309SearchPackageResponseDataPackages) UnmarshalJSON(data []byte) (err error) {
    varFulfillment202309SearchPackageResponseDataPackages := _Fulfillment202309SearchPackageResponseDataPackages{}

    err = json.Unmarshal(data, &varFulfillment202309SearchPackageResponseDataPackages)

    if err != nil {
        return err
    }

    *o = Fulfillment202309SearchPackageResponseDataPackages(varFulfillment202309SearchPackageResponseDataPackages)
