...
type _Fulfillment202309GetOrderSplitAttributesResponseDataSplitAttributes Fulfillment202309GetOrderSplitAttributesResponseDataSplitAttributes
...
func (o *Fulfillment202309GetOrderSplitAttributesResponseDataSplitAttributes) UnmarshalJSON(data []byte) (err error) {
    varFulfillment202309GetOrderSplitAttributesResponseDataSplitAttributes := _Fulfillment202309GetOrderSplitAttributesResponseDataSplitAttributes{}

    err = json.Unmarshal(data, &varFulfillment202309GetOrderSplitAttributesResponseDataSplitAttributes)

    if err != nil {
        return err
    }

    *o = Fulfillment202309GetOrderSplitAttributesResponseDataSplitAttributes(varFulfillment202309GetOrderSplitAttributesResponseDataSplitAttributes)

    additionalProperties := make(map[string]interface{})

    if err = json.Unmarshal(data, &additionalProperties); err == nil {
        delete(additionalProperties, "can_split")
        delete(additionalProperties, "must_split")
        delete(additionalProperties, "must_split_reasons")
