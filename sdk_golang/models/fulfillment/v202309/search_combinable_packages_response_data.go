...
// NewFulfillment202309SearchCombinablePackagesResponseData instantiates a new Fulfillment202309SearchCombinablePackagesResponseData object
...
type NullableFulfillment202309SearchCombinablePackagesResponseData struct {
	value *Fulfillment202309SearchCombinablePackagesResponseData
	isSet bool
}

func (v NullableFulfillment202309SearchCombinablePackagesResponseData) Get() *Fulfillment202309SearchCombinablePackagesResponseData {
	return v.value
}

func (v *NullableFulfillment202309SearchCombinablePackagesResponseData) Set(val *Fulfillment202309SearchCombinablePackagesResponseData) {
	v.value = val
	v.isSet = true
}

func (v NullableFulfillment202309SearchCombinablePackagesResponseData) IsSet() bool {
	return v.isSet
}

func (v *NullableFulfillment202309SearchCombinablePackagesResponseData) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableFulfillment202309SearchCombinablePackagesResponseData(val *Fulfillment202309SearchCombinablePackagesResponseData) *NullableFulfillment202309SearchCombinablePackagesResponseData {
	return &NullableFulfillment202309SearchCombinablePackagesResponseData{value: val, isSet: true}
}

func (v NullableFulfillment202309SearchCombinablePackagesResponseData) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableFulfillment202309SearchCombinablePackagesResponseData) UnmarshalJSON(src []byte) error {
	v.isSet = true
