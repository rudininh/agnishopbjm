...
import (
    ...
    "agnishopbjm/sdk_golang/models/fulfillment/v202309"
)
...
// PDF file data to be uploaded to TikTok Shop.  Prerequisites： - Only &#x60;PDF&#x60; file format is supported. - Original file size must not exceed 10MB.
...
// Image file data to be uploaded to TikTok Shop. The picture file is a string generated by base64 encoding. Prerequisites： - Image format must be &#x60;JPG&#x60;, &#x60;JPEG&#x60;, or &#x60;PNG&#x60;. - Image resolution must be between 100 x 100px and 20000 x 20000px. - Image size must not exceed 5MB.
