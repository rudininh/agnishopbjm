...
func Handler(w http.ResponseWriter, r *http.Request) {
	...
	url := fmt.Sprintf(
		"https://partner.shopeemobile.com%s?partner_id=%d&sign=%s&timestamp=%d&shop_id=%d&access_token=%s&offset=0&page_size=10&update_time_from=1611311600&update_time_to=1611311631&item_status=NORMAL",
	...
	url2 := fmt.Sprintf(
		"https://partner.shopeemobile.com%s?partner_id=%d&access_token=%s&timestamp=%d&shop_id=%d&sign=%s",
		path2, partnerID, token.AccessToken, timestamp2, token.ShopID, sign2,
	)
